...
\usepackage{./styles/langsci-gb4e-chinese-brackets}
...
% is loaded in grammatical-theory.tex and check-gt.tex to keep this customizable.
...
\usepackage{./styles/merkmalstruktur,styles/abbrev-chinese,styles/makros.2e,styles/my-xspace,styles/article-ex,
styles/eng-date}
...
\makeatletter
  \tcbset{before upper = {\parindent=2em\@afterheading\@afterindentfalse}}
\makeatother
