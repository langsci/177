...
\gll These apples, Harry must have been eating. \\
     这些 苹果 Harry 必须 \textsc{aux} \passivepst 吃\\
...
\gll Reports [the                 height of           the           lettering on            the          covers of which] the government prescribes should be abolished.\\
     报告     \spacebr \textsc{art}.\textsc{def} 高度   \textsc{prep}  \textsc{art}.\textsc{def} 印字       在……上  \textsc{art}.\textsc{def} 封面    \textsc{prep} \textsc{rel}  \textsc{art}.\textsc{def} 政府 规定 应该 \passivepst{} 废除 \\
