...
\isceat{beta-还原}{$\beta$-还原}{beta-reduction}{$\beta$-reduction}\label{Seite-beta-Reduktion}。
...
到目前为止，
\isce[|(]{成分序列}{constituent order}我们看到了函子与变元的各种组合：变元可以出现在函子左侧也可以出现在右侧。
...
\iscesub{成分序列}{constituent order}{自由}{free}
\iscesub{成分序列}{constituent order}{固定}{fixed}
