...
我们的讨论基于 \citet[2.1.2]{Steedman97a}的分析。
...
在范畴语法中，被动\isce[|(]{被动}{passive}的分析采用了词汇规则（\citealp[\page412]{Dowty78a}；\citealp[3.4]{Dowty2003a}）。
...
\end{tabular}
\z
 \citet[3.1]{Hoffmann95a-u}针对土耳其语\ilce{土耳其语}{Turkish}提出了一种类似日语的分析，这种分析的思想也可以用于分析德语的动词位置。
