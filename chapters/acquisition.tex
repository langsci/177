...
%the omittance of complete subjects is due to performance issues.\il{Italian|)}\il{English|)}
 ...
 \citet{Gerken91a}展示了话段的节律属性也起到一定作用：在一个儿童必须重复句子的实验中，这些儿童省略主语/冠词比省略宾语/冠词更为常见。这里，语调模式是抑扬的\isc{抑扬}\is{iambus}（弱-强）或者扬抑的\isc{扬抑}\is{trochee}（强-弱）。甚至可以发现以轻音节打头的单词比轻音节在单词尾的单词更加容易被省略。因此，比较起来，giRAFFE更容易省略为RAFFE，而`MONkey不容易省略为MON。 Gerken为话段假设了以下韵律\isc{韵律}\is{metrics}结构：
