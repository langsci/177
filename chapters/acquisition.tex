...
就这一问题，基于模式分析的支持者会极力争论说这类问题完全是形式框架\isc{形式化}\is{formalization}不完备造成的，如果不进行形式化就不会有这类问题\citep[\S~5]{Goldberg2009a}。但是，这一观点针对这一问题是没有用的，因为问题不在于形式框架本身，而是形式框架让人更好地看清楚问题。
