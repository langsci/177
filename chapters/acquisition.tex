...
见 \citew{Haider94c-u}和 \citew[\S~2.2]{Haider2001a}的综述。Haider认为虚位主语不出现与pro"=脱落之间至少存在一种关联。但是，加利西亚语\il{加利西亚语}\il{Galician}是一个带有虚位主语代词的pro"=脱落语言\citep[\S~2.5]{RU90a-u}。 \citet[\page 314]{Franks95a-u}指出上索布语\il{索布语!上索布语}\il{Sorbian!Upper}和下索布语\il{索布语!下索布语}\il{Sorbian!Lower} 是带有虚位主语的pro"=脱落语言。 \citet[\page 218]{SP2002b}指出在现代意大利语\il{意大利语}\il{Italian}中有一个虚位代词ci，虽然意大利语\il{意大利语}\il{Italian}是一种pro"=脱落语。  
...
\gll Mary picked the book up/picked up the book. \\           
     Mary 拾 \textsc{det} 书 \textsc{part}/拾 \textsc{part} \textsc{det} 书\\ \jambox{(动词—小品词\isc{动词!小品词}\is{verb!particle})}
\mytrans{Mary把书拾起来。} 
