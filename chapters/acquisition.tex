...
\zl
在这一发展阶段（22个月），儿童并不会使用这些图式进行概括，这些图式是构式岛并且没有任何句法 \citep{TADR97a}。在SVO语序中使用以前不知道的动词和主语以及宾语，在三岁到四岁之间习得很慢\citep[\page 128--129]{Tomasello2003a}。更加复杂的句法和语义关系只会随时间慢慢浮现：当多次遇到及物构式后，儿童就能概括这一构式了：
