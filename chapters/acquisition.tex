...
\begin{quotation}
成人语言社团中可以接受的表达构成了儿童的语言输入，它们也是儿童必须掌握的部分。这里所说的“可以接受”并不合乎英语语法（因为英语没有小代语主语，也无法被描述为一个简单VP）。这些句子缺少主语，因此违背了我们所假设的扩展投射原则\isc{扩展投射原则（EPP）}\is{Extended Projection Principle (EPP)}\citep{Chomsky81a}。
