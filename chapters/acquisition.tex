...
\z
Yang讨论了pro"=脱落\isc{参数!pro"-脱落|(}\is{parameter!pro"=drop|(}和话题省略参数\isc{参数!话题省略}\is{parameter!topic drop}。在pro"=脱落语言中（如意大利语\il{意大利语|}\il{Italian|}），可以省略主语；在话题省略语言（\egc 现代汉语\il{现代汉语}\il{Mandarin Chinese}）中，充当话题的主语和宾语都可以省略。Yang对比了说英语\il{英语|(}\il{English|(}和说汉语\il{现代汉语}\il{Mandarin Chinese}的儿童，发现说英语的儿童在很早的语言阶段就省略了主语和宾语。他主张这一现象的原因是说英语的儿童不使用汉语语法。
