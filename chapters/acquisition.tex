...
如果这一点是真的的话，那么基于模式方法剩下的就只是构式可以不连续实现的假设，以及不邻接成分之间也存在依存关系这一假设。习得问题就与基于选择的方法（将在下一章节讨论）一样：最终必须学习的是元素之间的依存或者说是价（见 \citew[\page 439]{Behrens2009a}，作者在考虑了多种因素之后得到了相似的结论）。%
\indexcxgend
