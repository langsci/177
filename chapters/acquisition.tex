...
\zl
英语有基本的SVO\isc{SVO}\is{SVO}语序。动词与宾语组合成一个组成成分（VP）然后再跟主语进行组合。所以参数设定一定是SV，VO和$-$V2。与此不同的是，德语是一个动词居末和动词二位的语言，所以参数取值应该是SV，OV和$+$V2。如果我们考虑 （\mex{-1}）中的句子，我们看到两个句子就动词及其论元次序的方面来看，二者是一致的。
