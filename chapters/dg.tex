...
\gll weil der Wagen zu reparieren versucht wurde\\
     因为 \textsc{det}.\sg.\nom{} 汽车 \textsc{inf} 修理 尝试 \textsc{aux}\\
\glt `因为试着修理这辆汽车'
...
\gll [Gezielt] [Mitglieder] [im     Seniorenbereich]       wollen  die Kendoka allerdings nicht werben.\footnotemark\\
    \spacebr{}特别地 \spacebr{}成员     \spacebr{}\textsc{prep}.\textsc{det} 高级.市民.选区 想要.\textsc{inf} \textsc{det} 剑道家 但是    不   招募\\
...
天 \textsc{prep} 天 \textsc{prep} 天 过 \textsc{prep} 但是 我 从未 找到 \textsc{det} 勇气 \textsc{inf} 说话 \textsc{inf} 她\\
