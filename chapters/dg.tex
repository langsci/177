...
\textsc{art}.\textsc{def} 孩子 经常 读 \textsc{art}.\textsc{def} 书 慢慢地\\
\mytrans{那个孩子经常慢慢地读书。}
\z
\begin{figure}
\centerline{%
...
[V
  [N
    [D,no edge,name=die [die;\textsc{art}.\textsc{def}] ]
     [Frauen;女人] ]
...
\gll Er hat das Buch nicht oft gelesen, sondern selten gekauft.\\
     他 \textsc{aux} \textsc{art}.\textsc{def} 书 不 经常 读     而是 很少 买\\
...
\gll Dem Saft eine kräftige Farbe geben Blutorangen.\footnotemark\\
     \textsc{art}.\textsc{def} 果汁 一   强烈   颜色 给 血.橙\\
...
dg edges
[V
  [N [Det,tier=eine [dem;\textsc{art}.\textsc{def}]]
   [Saft;果汁] ]
  [N, l sep+=3pt 
...
dg edges
[V\sub{g}
  [V,edge=dashed [N [Det [dem;\textsc{art}.\textsc{def}]]
      [Saft;果汁] ]
     [N [Det [eine;一] ]
        [Adj, dg adjunct=4pt [kräftige;强烈]]
        [Farbe;颜色]]
...
\gll [Gezielt] [Mitglieder] [im     Seniorenbereich]       wollen  die Kendoka allerdings nicht werben.\footnotemark\\
    \spacebr{}特别地 \spacebr{}成员     \spacebr{}\textsc{prep}.\textsc{art}.\textsc{def} 高级.市民.选区 想要
    \textsc{art}.\textsc{def} 剑道家 但是    不   招募\\
...
[{V[\dom \phonliste{ der Frau, ein Mann, das Buch, gibt }]}
  ...
  [{V[\dom \phonliste{ der Frau, das Buch, gibt }]}
   [{NP[\type{dat}, \dom \phonliste{ der, Frau  }]} [der Frau;\textsc{art}.\textsc{def} 女人,roof] ]
   [{V[\dom \phonliste{ das Buch, gibt }]}
    [{~~~NP[\type{acc}, \dom \phonliste{ das, Buch }]} [das Buch;\textsc{art}.\textsc{def} 书,roof] ]
...
sm edges
[{V[\dom \phonliste{ der Frau, ein Mann, das Buch, gibt }]}
  [{NP[\type{dat}, \dom \phonliste{ der, Frau  }]~~~~~~}, no edge, name=np-dat,tier=dat-tier, [der Frau;\textsc{art}.\textsc{def} 女人,roof] ]
  [{NP[\type{nom}, \dom \phonliste{ ein, Mann }]} [ein Mann;一 男人, roof]]
...
[{V[\dom \phonliste{ die, Frauen, Türen, öffnen }]}
  [{D[\dom \phonliste{ die }]},no edge,name=die,tier=det-n [die;\textsc{art}.\textsc{def}] ]
