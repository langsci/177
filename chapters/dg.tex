...
\z
%\addlines
符号“$\bigcirc$”\isce{置乱关系}{$\bigcirc$}\iscesub{关系}{relation}{置乱关系}{$\bigcirc$}\isrel{shuffle}\label{rel-shuffle}表示shuffle（置乱关系）。shuffle（置乱关系）连接了A、B和C三个列表，当且仅当C包括了A和B中的所有成分，而且A中成分的语序和B中成分的语序保存在C中。（\mex{1}）分别显示了带有两个成分的两个集合的组合：
