...
\gll The          mother gave [the girl] [a cookie].\\
     \textsc{det} 妈妈    给   \spacebr\textsc{det} 女孩 \spacebr一 饼干\\
\glt `妈妈给这个女孩饼干。'
}
\ex[]{
{}\gll [The girl]              was          given [a cookie]               (by the mother).\\
      \spacebr\textsc{det} 女孩 \textsc{aux} 给    \spacebr一 饼干 \hspaceThis{(}\textsc{prep} \textsc{det} 妈妈\\
\glt `这个女孩从妈妈那里得到了饼干。'
}
\ex[*]{
\gll It    was          given [the girl] [a cookie].\\
     \expl{} \textsc{aux} 给    \spacebr\textsc{det} 女孩 \spacebr一 饼干\\
}
\zl
%
