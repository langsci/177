...
\gll Es ist nicht der Fall, daß er mindestens einem Verleger fast jedes Gedicht anbot.\\
     它 \textsc{cop} 不 \textsc{det} 事实 \textsc{comp} 他 至少 一 出版社 几乎 每 诗 提供\\
...
\gll Es ist nicht der Fall, daß er fast jedes Gedicht$_i$ mindestens einem Verleger \_$_i$ anbot.\\
	 它 \textsc{cop} 不 \textsc{det} 事实 \textsc{comp} 他 几乎 每 诗 至少 一 出版社 {} 提供\\
\glt `事实并不是他给至少一家出版社提供了几乎每一首诗。'
...
``neighborhood''?\\
\textsc{aux} 或 \textsc{aux} 我们 合作 我们的 资本 \textsc{prep} \textsc{comp} \textsc{prep} 其他的 合作者 \textsc{inf} 应对 \textsc{det} 需求 \textsc{prep} 一 区域的 \hspaceThis{``}邻居\\
