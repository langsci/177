...
\ref{Abschnitt-T-Modell}介绍所谓的T模型，即\gbtc 的基本架构。\ref{Abschnitt-X-Bar}介绍\gbc 中用到的\xbartc 理论的特殊形式，\ref{sec-GB-CP-IP-System-English}展示了\xbarc 理论的这个版本是如何应用在英语中的。
