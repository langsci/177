...
% \citew{Tomasello95a},  \citew{Wunderlich2004a},  \citew*{HCF2002a} and  \citew{Chomsky2007a}. For more on this discussion, see Chapter~\ref{chap-innateness}.
 ...
 \citet{Chomsky81a}还假定，存在语言结构不能违反的普遍、内在原则。这些原则是参数化的，即不只有一个选项。参数\isc{参数!中心语位置}\is{parameter!head position}\isc{参数}\is{parameter}设置在不同语言中是不同的。如下面例（\mex{1}）中的参数化原则：
