...
\noindent
在简单介绍了动词末位语序的分析之后，我将详细说明德语的CP/IP分析。\cnullc 对应句子的左边界，并且可以按照两个不同的方式来填充：与英语一样，在由连词引导的从句中，从句连词（标补语\isc{标补语}\is{complementizer}）占据\cnullc 的位置。动词还是位于句子的右边界，如例（\mex{1}）所示。
