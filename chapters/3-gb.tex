...
动词可以通过后面加词缀的方式由名词派生出来\isc{后-构成}\is{back-formation}（如uraufführen，首演）这些词通常不能再切分，这样就无法构成V2从句（ \citet{Hoehle91b}在未发表的工作中首次提出这一观点。正式的出版物首见于 \citew[\page 62]{Haider93a}）：
