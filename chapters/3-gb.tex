...
\gll Der Professor schlägt dem Studenten vor, die Klausur noch mal zu~~~~~~ schreiben.\\
	 \textsc{det} 教授 建议 \textsc{det} 学生 \textsc{prt} \textsc{det} 考试 一次 再 INF 写\\
\glt `教授建议学生再参加一次考试。'
...
\gll Der Professor schlägt dem Studenten vor, die Klausur nicht zu bewerten.\\
	 \textsc{det} 教授 建议 \textsc{det} 学生 \textsc{prt} \textsc{det} 考试 不 INF 打分\\
\glt `教授建议学生这次考试不打分。'
...
\gll Der Professor schlägt dem Studenten vor, gemeinsam ins Kino zu gehen.\hspace{-3pt}\\
	 \textsc{det} 教授 建议 \textsc{det} 学生 \textsc{prt} 一起 进入 电影院 INF 去\\
\glt `教授建议学生一起去电影院。'
...
\gll Der Clown versucht, Kurt-Martin die Ware zu geben.\\
     \textsc{det} 小丑 尝试 Kurt-Martin \textsc{det} 物品 INF 给\\
...
\gll {}[Um zwei Millionen Mark]$_i$ soll er versucht haben, [eine Versicherung \_$_i$ zu betrügen].\footnotemark\\
     {}\spacebr{}大约 两 百万 德国马克 应该 他 试图 \textsc{aux} \spacebr{}\textsc{art} 保险公司 {} INF 欺骗\\
...
\gll {}[Gegen ihn]$_i$ falle es den Republikanern hingegen schwerer,~~~~~~~~~~~~~~~~~~~~~ [~[~Angriffe~\_$_i$] zu lancieren].\footnotemark\\
	 {}\spacebr{}反对 他 陷阱 它 \textsc{det} 共和党人们 但是 更难 \hspaceThis{[~[~}攻击 INF 发起\\
\footnotetext{
...
\textsc{det} 妈妈 给 \textsc{det} 女孩 \textsc{art} 饼干\\
\glt `妈妈给这个女孩饼干。'
}
\ex[]{
{}\gll [The girl] was given [a cookie] (by the mother).\\
\textsc{det} 女孩 \textsc{aux} 给 \textsc{art} 饼干 \textsc{prep} \textsc{det} 妈妈\\
\glt `这个女孩从妈妈那里得到了饼干。'
}
\ex[*]{
\gll It was given [the girl] [a cookie].\\
它 \textsc{aux} 给 \textsc{det} 女孩 \textsc{art} 饼干\\
}
\zl
%
...
``neighborhood''?\\
\textsc{aux} 或 \textsc{aux} 我们 合作 我们的 资本 \textsc{prep} \textsc{conj} \textsc{prep} 其他的 合作者 INF 应对 \textsc{det} 需求 \textsc{prep} \textsc{art} 区域的 邻居\\
