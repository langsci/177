...
模型论的方法总是基于约束的，所以说模型论（model"=thoretic）和基于约束（constraint"=based）的理论有时是同义的。} （请看第\ref{Abschnitt-Generativ-Modelltheoretisch}章的讨论）。在1965年，乔姆斯基按照下面这种方式来界定生成语法（Generative Grammar）（也可以参考\citealp[\page 162]{Chomsky95a-u}）：
