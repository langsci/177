...
\mytrans{水管工的拜访}
\zl
在第一个例子中，主语带主格\isc{格!主格}\is{case!nominative}，而在第二个例子中，Installateur（水管工）是宾格\isc{格!宾格}\is{case!accusative}，在第三个例子中，它则紧跟主格\isc{主格化}\is{nominalization}后面的属格\isc{格!属格}\is{case!genitive}。宾语的宾格通常是结构格。这个格在被动化后\isc{被动}\is{passive}变成主格：
