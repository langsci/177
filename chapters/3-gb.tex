...
副词的辖域取决于它们的语序：位于最左边的副词辖域囊括其后的两个成分。\footnote{%
...
\citealp[\S~9.1]{AW98a}; \citealp{Tomasello2000a,Tomasello2003a}）。此外，我们无法证明某个参数跟不同的语法现象之间存在联系。更多的内容，请参考第\ref{chap-acquisition}章。
