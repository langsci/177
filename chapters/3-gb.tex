...
在介绍\ref{sec-case-assignment}的被动\isce{被动}{passive}分析前，第一小节将详细说明结构格\isce[|(]{格}{case}{结构格}{structural}与词汇格\iscesub[|(]{格}{case}{词汇格}{lexical}的区别。
...
\mytrans{他被帮助了。}
\zl
与格应该被看作是词汇格，还是在动词结构环境中的一些或者所有与格都应该被看作是结构格，这个问题存在争议。限于篇幅，我不在这里展开讨论，有兴趣的读者可以参考 \citew{MuellerLehrbuch1}中第14章的内容。接下来，我将按照 \citet[\page 20]{Haider86}的假设，认为与格实际上是一个词汇格。\isce[|)]{格}{case}{结构格}{structural}\iscesub[|)]{格}{case}{词汇格}{lexical} 
