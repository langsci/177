...
\end{tabular}
\z
这条转换规则将左侧树形图中的符号对应到另一棵树的规则，其中待变换的树需要匹配规则左部的符号标记，而变换得到的树需要匹配到规则右部的符号标记。相应地，规则右部的数字标号1、2和3分别对应规则左部的相应数字标号。\emph{en} 表示构成助词（seen、been，还有loved）的语素。图\ref{fig-Passivtransformation}显示了例（\mex{1}a、b）的树形图。
