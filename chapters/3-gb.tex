...
为了分析这些语序，我们提出了两条建议：第一条建议是假定（\mex{0}b--f）中的五种语序是通过\movea \citep{Frey93a}从一个隐含的语序推导出来的。举例来说，对（\ref{ex-das-buch-der-mann-der-frau-gibt}）的分析如图\vref{fig-das-buch-der-mann-der-frau-gibt-movement}所示。
