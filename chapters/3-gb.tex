...
Martin Haspelmath\aimention{Martin Haspelmath}指出，我们可以提出这样一条规则，将中心语后的论元成分移位到中心语前的位置上（请参阅\citealp[\page 89]{Riemsdijk78a}有关转换方法的讨论）。这与德语形容词的前置论元的情况是一致的：
\eal
\ex
...
%} 
由于这一二元特征可以有否定或肯定的特征值，这样就构成了另外四个范畴。因此一共有八个可能的特征组合，其中有一些不属于任何貌似合理的范畴。
