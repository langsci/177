...
应用这一交叉分类，我们就有可能归纳出普遍的规律。比如说，我们可以这样简单地指称形容词和动词：所有带有 [~+V~]的词汇范畴要么是形容词，要么就是动词。此外，我们也可以说带有[~+N~] 范畴的（即名词和形容词）都可以有格属性。
...
（如 \citealp[\page 52]{Grewendorf88a}、\citealp[\page 124]{Haftka96a}和G.\ \citealp[\page 238]{GMueller2011a}）。在德语带有介词和名词的结构，其中心语位于补足语之前：
