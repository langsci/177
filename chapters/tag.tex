...
这里有意思的是这种方法和 \citet[2.1.3]{Berman96a-u}在LFG\indexlfg 中的分析很像（参见\ref{Abschnitt-LFG-Umstellung}）：
...
本书中\isce[|(]{语言能力}{competence}\isce[|(]{语言运用}{performance}讨论的很多理论都区分语言能力（competence）和语言运用（performance）\citep[I.1]{Chomsky65a}。我们假定语言能力理论描写语言知识，而语言运用理论应该解释语言知识如何被使用以及为什么我们在使用和理解语言的过程中会产生错误等问题。参见第\ref{chap-competence-performance}章以了解更多的内容。 
