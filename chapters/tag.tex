...
处理量词作用域\isce{辖域}{s\textsc{cop}e}，他们也讨论了嵌入动词的复杂情况。感兴趣的读者可以阅读他们的原文。
...
\isce{多成分树邻接语法}{Multi-Component TAG}\isc{树邻接语法（TAG）!多成分树邻接语法（MC-TAG）|(}\is{Tree Adjoining Grammar (TAG)!Multi"=Component (MC-TAG)|(}
...
对于不定式动词，假定主语由一个PRO
\isce{PRO}{PRO}来实现。PRO像\emph{e}一样，是一个语音形式为空的代词性范畴
