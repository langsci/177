...
\begin{itemize}
\item 阿拉伯语\il{阿拉伯语 Arabic}\citep{Attia2008a-u}
\item 阿伦特语\il{阿伦特语 Arrernte}\citep*{Dras2012a-u}
\item 孟加拉语\il{孟加拉语 Bengali}\citep{SC97a-u}
%\item Chinese\il{Mandarin Chinese}
\item 丹麦语\il{丹麦语 Danish}\citep{Oersnes2002b-u,OW2003a-u,OW2004a-u}
\item 英语\il{英语 English}\citep*{HHP91a-u,BDFK99a-u,RKKCMJ2002a-u,KM2007a-u}
\item 法语\il{法语 French}\citep*{Zweigenbaum91a-u,Frank96b-u,FZ2002a-u,BDFK99a-u,CK2001a-u,BSL2005a-u,SdA2016a-u,Alencar2017a-u}
% Knueppel2001a-u
%
%
\item 格鲁吉亚语\il{格鲁吉亚语 Georgian}\citep{Meurer2009a-u}
...
\item 匈牙利语\il{匈牙利语 Hungarian}\citep{LRT2010a-u}
\item 印度尼西亚语\il{印度尼西亚语 Indonesian}\citep*{AADMS2009a-u}
\item 意大利语\il{意大利语 Italian}\citep*{Delmonte90a-u,Mayo99a-u,Quaglia2012a-u}
\item 爱尔兰语\il{爱尔兰语 Irish}\citep{Sulger2009a-u,Sulger2010a-u}
\item 日语\il{日语 Japanese}\citep*{HHP91a-u,MO2003a-u,Umemoto2006a-u}
\item 韩语\il{韩语 Korean}\citep*{HHP91a-u}
\item 马达加斯加语\il{马达加斯加语 Malagasy}\citep*{Randriamasimanana2006a-u,DLM2006a-u}
\item 现代汉语\il{现代汉语 Mandarin Chinese}\citep*{HHP91a-u,FK2007a-u}
\item 穆林--帕塔语\il{穆林--帕塔语 Murrinh-Patha}\citep{SN2012a-u}、
\item 挪威语\il{挪威语 Norwegian}\citep*{DMR2005a}、
\item 波兰语\il{波兰语 Polish}\citep*{PP2012a-u}、
\item 葡萄牙语\il{葡萄牙语 Portuguese}\citep{Alencar2004a-u,Alencar2013a-u,Alencar2015a-u}、
\item 西班牙语\il{西班牙语 Spanish}\citep{Mayo99a-u}、
\item 提格里尼亚语\il{提格里尼亚语 Tigrinya}\citep{Kifle2012a-u}、
\item 土耳其语\il{土耳其语 Turkish}\citep{CO2006a-u}、
\item 匈牙利语\il{匈牙利语 Hungarian}\citep*{LRT2010a-u,RLC2011a-u}、
\item 乌尔都语\il{乌尔都语 Urdu}/印地语\il{印地语 Hindi}\citep*{BHKR2007a-u,BBS2008a-u}、
\item 威尔士语\il{威尔士语 Welsh}\citep{MS2005a-u}和
\item 沃洛夫语\il{沃洛夫语 Wolof}\citep{Dione2012b-u,Dione2013a-u}。
\end{itemize}
上述语法中有很多都是基于ParGram开发的\footnote{%
  \url{http://pargram.b.uib.no/research-groups/}。\zhdate{2015/10/01}。
} \citep*{BKNS99a-ed,BDKMR02a-u}。 
除了上述语法，一个针对北梭托语\il{北梭托语 Northern Sotho}的语法也正在研发\citep{Faasz2010a-u}。
...
\textsc{xcomp}
\isfeat{xcomp}: & 非自足性（谓词性）补足语，通常为不定式，通常有一个外部的成分约束\isc{约束}\is{control}其\textsc{subj}\\
...
\pred 的规约对应于GB理论中的题元格\isc{θ-栅}\is{theta-grid@$\theta$-grid}。
中心词的配价\isc{价}\is{valence}信息也包含在\predvc 的规约信息中。
...
\isc{c-结构}\is{c"=structure|)}\il{英语 English|)}

\subsection{语义}
\label{lfg-semantics}
\label{glue-semantics}

依据 \citet[\page 90--92]{Dalrymple2006a}，粘着语义学（glue semantics）\isc{粘着语义学|(}\is{glue semantics|(}是LFG的一个主流语义分析方法（\citealp*{DLS93a-u}；\citealp[\S~8]{Dalrymple2001a-u}）。
...
\citet{Dalrymple99a-ed}讨论了针对量化\isc{量化}\is{quantification}、修饰和其他现象的粘着语义分析。 
...
想了解更多的关于语序线性化的限制，可以参考 \citew{ZK95b}\isc{说明语}\is{adjunct}。
...
\mbox{} \citet{BM95a}\isc{被动|(}\is{passive|(}\isc{形态|(}\is{morphology|(}主张将词视为构造句法结构的原子成分（词汇完整性\isc{词汇完整性}\is{lexical integrity}\footnote{%
...
在LFG中，语法功能\isc{语法功能}\is{grammatical function}是基础要素，换句话说它们不是通过句法树中的位置推导出来的（如Subject = SpecIP）。
...
（\mex{1}）展示了德语动词verschlingen（吞食）的词汇项信息：\footnote{%
  ...
  作为一种替代性分析，也可以从格中推导出一个名词短语的语法功能（\citet[\page 37]{Berman2003a}的德语分析；\citet[\page 187, \page 201]{Bresnan2001a}的德语和俄语分析\il{俄语 Russian}）。
...
也就是说，结合语法中其他的可与之交互的规则，相应的VP变成可选的。\isc{成分序列|)}\is{constituent order|)}  

\section{长距离依存和功能多变性}
\label{Abschnitt-NLA-LFG}

我们\isc{长距离依存}\is{long"=distance dependency|(}已经知道了LFG可以解释被动、局部语序重列、不基于转换的动词位置的语言现象。
...
不同于论元功能，语篇功能\textsc{topic}\isfeat{topic}\isc{话题}\is{topic}和\textsc{focus}
...
这意味着语篇和语法功能的同一性关系尚待确定，这种性质称为功能不确定性（functional uncertainty\isc{功能不确定性}\is{functional uncertainty}），见 \citew{KZ89a}。
...
一致性\isc{一致性}\is{coherence}和完备性\isc{完整性}\is{completeness}保证了长距离依存可以被正确处理，也就是说，它保证了一个前置的宾语并不会分配给
...
这个特殊的论元被称为指定的论元（designated argument\isc{指派论元}\is{argument!designated}）。
...
作者们展示了如何使用XLE系统来开发一部法语\il{法语 French}LFG语法。
