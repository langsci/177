...
\item 汉语\il{Mandarin Chinese}\citep*{HHP91a-u,FK2007a-u}
...
（\mex{1}）展示了德语动词verschlingen（吞食）的词汇项信息：\footnote{%
  ...
  作为一种替代性分析，也可以从格中推导出一个名词短语的语法功能（\citet[\page 37]{Berman2003a}的德语分析；\citet[\page 187, \page 201]{Bresnan2001a}的德语和俄语分析\il{Russian}）。
