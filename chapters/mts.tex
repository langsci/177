...
生成"=枚举方法\isc{模型论语法|(}\is{model"=theoretic grammar|(}假设语法生成一个符号序列的集合（词串）。这就是术语生成语法\isc{生成语法}\is{Generative Grammar} 的由来。所以，可以利用第~\pageref{bsp-grammatik-psg}页的语法，在这里重写为（\mex{1}），得出词串er das Buch dem Mann gibt（他 DET 书 DET 男人 给）。
