...
\gll Die Mitglieder des Politbüros wurden eines / einer nach dem anderen aus dem Saal getragen.\\
	 \textsc{det} 成员.\neu{} \textsc{det} 政治局 \textsc{aux} 一.\neu{} {} 一.\mas{} \textsc{prep} \textsc{det} 另外的 \textsc{prep} \textsc{det} 大厅 运送\\
...
Keller.\\
\textsc{det} 成员.\neu{} \textsc{det} 女人的.跳舞.俱乐部 离开 一.\neu{} {} 一.\fem{} \textsc{prep} \textsc{det}.\neu{} {} \textsc{det}.\fem{} 另外的 \textsc{prep}.\textsc{det} 保护 \textsc{det} 黑暗的 \textsc{det}
地下室\\
...
\hspaceThis{"`}颜色 带来 \deter~ 最多 钱 揭露 \deter~ 14-年龄.老  土耳其 女孩.\neu{} \textsc{rel}.\fem{} \textsc{det} 墙.碎片
...
\gll Es ist ein junges {\em Mädchen\/}, {\em die\/} auf der Suche nach CDs bei Bolzes reinschaut.\footnotemark\\
	 他 \textsc{cop} 一 年轻的 女孩.\neu{} \texctsc{rel}.\fem{} \textsc{prep} \textsc{det} 寻找 \textsc{prep} CDs \textsc{prep} Bolzes 停下.\textsc{prep}\\
\footnotetext{%
