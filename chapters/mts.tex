...
生成"=枚举方法\isc{模型论语法|(}\is{model"=theoretic grammar|(}假设语法生成一个符号序列的集合（词串）。这就是术语生成语法\isc{生成语法}\is{Generative Grammar} 的由来。所以，可以利用第~\pageref{bsp-grammatik-psg}页的语法，在这里重写为（\mex{1}），得出词串er das Buch dem Mann gibt（他 \textsc{det} 书 \textsc{det} 男人 给）。
...
\gll Du kennst diesen Aufsatz.\\
	 你 知道.\textsc{2sg} \textsc{det}.\acc{} 散文\\
%\gll Du kennst diesen Aufsatz.\\
%	 you know.\textsc{2sg} this.\acc{} essay\\
}
\ex[*]{
\gll Du kennen diesen Aufsatz.\\
	你 知道.\textsc{3pl} \textsc{det}.\acc{} essay\\
%\gll Du kennen diesen Aufsatz.\\
...
\ex
\gll Die Fenster wurden eins nach dem anderen ge-schloss-en.\\
...
\gll Die Türen wurden eine nach der anderen geschlossen.\\
	\textsc{det} 门.\fem{} \textsc{aux} 一.\fem{} \textsc{prep} \textsc{det} 其他 \textsc{ptcp}.关.\textsc{ptcp}\\
\glt `门被一个接一个地关上了。'
%\gll Die Türen wurden eine nach der anderen geschlossen.\\
...
\gll Die Riegel wurden einer nach dem anderen zugeschoben.\\
	 \textsc{det} 门闩.\mas{} \textsc{aux} 一.\mas{} \textsc{prep} \textsc{det} 其他 \textsc{inf}.\textsc{ptcp}.关.\textsc{ptcp}\\
\glt `门闩被一个接一个地关上了。'
%\gll Die Riegel wurden einer nach dem anderen zugeschoben.\\
...
\glt `\,“彩色的最贵”，一个在查理检查站向日本人和美国人出售墙碎片的14岁土耳其小女孩说。'
...
\gll Es ist ein junges {\em Mädchen\/}, {\em die\/} auf der Suche nach CDs bei Bolzes reinschaut.\footnotemark\\
	 他 \textsc{cop} 一 年轻的 女孩.\neu{} \textsc{rel}.\fem{} \textsc{prep} \textsc{det} 寻找 \textsc{prep} CDs \textsc{prep} Bolzes 停下\\
\footnotetext{%
        taz，\zhdate{1996/03/13}，第11页。
      }
\par}
\glt `有一个寻找CD的小女孩在Bolzes停下了。' 
%\gll Es ist ein junges {\em Mädchen\/}, {\em die\/} auf der Suche nach CDs bei Bolzes reinschaut.\footnotemark\\
