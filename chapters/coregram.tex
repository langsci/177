...
\end{figure}%
对于屈折词，相关词根\isce{词根}{root}在词库中。例如，schlaf-（睡觉）、lieb-（爱）和geb-（给）。在图\ref{Abbildung-Hierarchie}中，有\type{root}的不同次类型，词根的概括类型：例如，\type{intrans-verb}代表不及物动词，\type{trans-verb} 代表及物动词。及物动词可以进一步划分为严格及物动词（带有主格和宾格论元）和双及物动词（带有主格和宾格和与格论元）。上述层级当然必须需要大幅改进，因为及物和不及物动词都会有进一步的分类。例如，不及物动词可以分为非宾格\iscesub{动词}{verb}{非宾格}{unaccusative}和非作格\iscesub{动词}{verb}{非作格}{unergative}动词，并且即便是严格的及物动词也可以进一步区分出小类（见\citet[第2节]{Welke2009a}）。
