...
注意蕴涵普遍性\isc{普遍性!蕴涵}\is{universal!implicative}可以从正如这里提出的层级安排的约束集合中推导出来。例如，可以从图\ref{fig-german-dutch-danish-english-french}中推导出蕴涵关系，所有的SVO语言都是V2语言，因为不存在一种语言包含集合4中的约束，但是不包含集合7中的约束。当然，这一蕴涵表述是错误的，因为有很多SOV语言，但是只有很少的V2语言。所以，只要我们增加其他语言，例如波斯语或日语，这张图就变了。
