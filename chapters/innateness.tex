...
因此，对于习得英语来说，先学习一些助动词的范式是Aux NP VP，然后再了解到所有助动词都符合这个模式，这样就足够了。 \citet{LE2001a}也证明了这个观点，他训练了一个神经网络\isc{神经网络|(}\is{neural network|(}，其中使用了助动词构式中不包括带有关系从句的NP的数据。但是，关系小句在其他结构中有。训练语料的复杂度一点一点增加，就像儿童接收语言输入一样\citep{Elman93a}。\footnote{%
