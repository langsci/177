...
通常认为\isce[|(]{X-理论@\xbar-理论}{X-theory@\xbar-theory}，所有语言都有对应于\xbarc 模式的句法结构（见\ref{sec-xbar}）（\citealp[\page
...
\noindent
 \citet{KK70a}针对叙实动词提出了一个带有名词性中心语的复杂名词短语。一个可选的“事实”删除-转换\isce{转换!事实-删除@\emph{事实}-删除}{transformation!fact-Deletion@\emph{fact}-Deletion}去掉了诸如（\mex{1}a）句中NP的中心语名词和限定语，从而推导出诸如（\mex{1}b）的句子（第159页）。
