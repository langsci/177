...
如果我们的语言知识不包括任何有关变换的信息，那么他们关于需要学习什么的观点就是错误的。例如，我们可以假设，正如范畴语法\isc{范畴语法}\is{Categorial Grammar (CG)}所主张的，助动词构成了一组具有特殊分布属性的词类。一种可能的布局是疑问句中观察到的首位，另一种是在主语后\citep[\page 104]{Villavicencio2002a}。
