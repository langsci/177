...
{}[\sub{NP} 许多 书 [\sub{PP} \textsc{prep} [故事 t]] t$'$]  \textsc{aux} 卖 [\textsc{conj} 我 想 INF 读]\\
\glt `有许多我想读的带故事的书都被卖了。'
\ex
\gll {}[\sub{NP} Many proofs [\sub{PP} of [the theorem t]] t$'$] appeared [that I wanted to think about].\\
    {}[\sub{NP} 许多 证据 [\sub{PP} \textsc{prep} [\textsc{det} 定理 t]] t$'$] 出现 [\textsc{conj} 我 想 INF 思考 \textsc{prep}].\\
...
\gll weil viele Schallplatten mit Geschichten verkauft wurden, die ich noch lesen wollte\\
	 因为 许多 唱片 \textsc{prep} 故事 卖 \textsc{aux} \textsc{conj} 我 仍 读 想\\
...
教授, 关于 法律, [\textsc{conj} \textsc{aux} 不 指派 或者 \textsc{prep} 任何 方式 要求 INF 阅读]$_i$.\\
...
我们 起草 [\sub{NP} \textsc{art} 列表 \textsc{prep} [\sub{NP} 基本 需求 \_$_i$ ]] 那 晚上 [\textsc{conj} \textsc{aux} INF \textsc{aux}
...
know.\\
我 要 喜欢 INF 告诉 你 另一个 有趣的 故事 但是 我.\textsc{aux} 已经 告诉 你 \textsc{det} 唯一 PRON 我 知道\\
...
我.\textsc{aux} 更 教 语言学 INF \textsc{art} 学生 \textsc{prep} 数学 比 INF PRON \textsc{prep}  任何 专业 \textsc{prep} \textsc{det} 人文学科\\
...
哪儿.\textsc{aux} \textsc{det} 申请表 Mark 承诺 INF 填 \textsc{prep}\\
...
\textsc{det} 申请表 Mark [\sub{\textsc{aux}} 过去] 承诺 INF 填 \textsc{prep} [\sub{\textsc{aux}} \textsc{aux}] 那儿\\
\glt `Mark过去承诺要填的表在那儿'
}
\ex[*]{
\gll Where did the application Mark promised to fill out is?\\
哪儿 \textsc{aux} \textsc{det} 申请表 Mark 承诺 INF 填 \textsc{prep} \textsc{aux}\\
}
\zl
