...
86--87]{Chomsky2002a-u}），然后这就暗示了语言包括无限多的表达式。 \citet{PS2010a}指出，这个论据有两个错误：即使我们认同生成语法，仍有可能是，即使有递归规则，对语境敏感的语法也只能生成有限的集合。 \citet[120--121]{PS2010a}引述了Andr{\'a}s Kornai\aimention{Andr{\'a}s Kornai}举出的一个有趣的例子。
