...
\z
Stefanowitsch研究的是收录了英式英语的英语国际语料库（International Corpus of English\il{English}，ICE-GB）。在这个语料库中，动词say出现了3,333次，带有双及物动词的句子（Subj Verb Obj Obj）出现了1,824次。数据库中动词的总数达136,551个。如果所有的动词在所有类型的句子中以相同的频率出现的话，那么我们会希望得到这样的结果，say在双及物构式中出现了44.52次（X / 1,824 = 3,333 / 136,551 所以 X = 1,824 $\times$ 3,333 / 136,551）。但是，这个表达式出现的实际数量是0，跟（\mex{1}b）不同，说英语的人不适用于（\mex{1}a）这样的句子。
