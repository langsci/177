...
对于（\mex{0}）中其余的观点，需要跨学科的研究工作：缺陷的具体化要落实到形式语言\isc{形式语言}\is{formal language}的理论中（句子的集合的具体化），不可或缺论是一个学习理论\isc{学习理论}\is{learning theory}领域中的数学任务，不可及的证据是一个语言事实方面的问题，可以通过语料库获得，最终习得的证据是实验发展心理学的问题\citep[\page 19--20]{PS2002a}。
