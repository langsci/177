...
负向证据的另外一种形式是间接的负向证据\isce{证据!负向证据!间接负向证据}{evidence!negative!indirect}， \citet[\page 9]{Chomsky81a}认为它们也可以在习得中起作用。 \citet[\S~5.2]{Goldberg95a}举出（\mex{1}a）中的句子作为例子：\footnote{%
