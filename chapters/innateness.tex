...
邻接原则被认为是具有语言共性的。邻接限制规定移位操作可以跨越一个约束节点\isc{约束节点}\is{bounding node}，而到底什么是约束节点，则取决为研究的语言（Baltin \citeyear[\page 262]{Baltin81a}；\citeyear{Baltin2006a}；\citealp[\page 57]{Rizzi82b}；\citealp[\page 38--40]{Chomsky86b}）。\LATER{ \citew{PB90a,Newmeyer91a}}\footnote{%
