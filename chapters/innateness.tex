...
我们可以在图\ref{Abbildung-Analyse}中找到（\mex{0}b）的两种分析。（\mex{0}b）的第一种分析的可能性对应于从所有子树的集合中选择[the [dog barks]]的完整树的概率。因为有十二棵子树，选择这个完整树的概率是1/12。第二个分析的概率是组合子树的概率的结果，由此是1/12 $\times$ 1/12 = 1/144。（\mex{0}b）的分析的概率就是1/12 $+$ (1/12 $\times$ 1/12) = 13/144。
