...
\mbox{}\isc{参数!中心语导向|(}\is{parameter!head direction|(}%
...
\isc{参数!中心语导向|)}\is{parameter!head direction|)}
...
通常\isce{习得!习得速度|(}{acquisition!speed|(}认为，儿童学习语言异常快，而这只能是因为他们已经掌握了不需要习得的关于语言的知识（如\citet[\page 144]{Chomsky76c-u}；\citet[\page
...
此外，跟第二语言习得\iscesub{习得}{acquisition}{第二语言习得}{second language}相比，第一语言习得是毫不费力且迅速的这个说法是错误的，正如 \citet[\page 9]{Klein86a-u}的估算所显示的：如果我们假设儿童每天听五个小时的语言会话（保守估计），那么在他们生命中的头五年中，他们有9100小时的语言训练。但是到五岁的时候，他们仍没有习得所有的复杂结构。相比较而言，第二语言学习者，假设有必要的动机，可以在为期六周每天十二个小时（总共500小时）的集训课上学会一门语言的语法。\isce{习得!习得速度|)}{acquisition!speed|)}
...
\noindent
有关英语中助动词位置的知识是在儿童3岁2个月时习得的。根据Legate和Yang，我们需要另一个在3岁2个月时学会的习得现象来进行比较。作者重点讨论了主语脱落问题\isce{参数!pro-脱落|(}{parameter!pro-drop|(}\footnote{%
...
第二，在构造他们的刺激贫乏论时，Legate和Yang认为天赋的语言知识（pro-脱落参数\isce{参数!pro-脱落|)}{parameter!pro-drop|)}）是存在的。
...
\mbox{} \citet{Bod2009a}\isce[|(]{助动词倒装}{auxiliary inversion}\isce[|(]{统计学}{statistics}\isc{无监督的面向数据的句法分析（U-DOP）|(}\is{Unsupervised Data-Oriented Parsing (U-DOP)|(}开发了一套不需要任何有关句中词类或词间关系信息的程序。
