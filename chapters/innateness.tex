...
但是， \citet[\page 230]{PJ2005a}指出，导航与Chomsky描述的递归系统不同，递归不是在所有的文化中都是计数系统的一部分。他们认为，那些发展出无限计数系统的文化可以这么做（译者注：将递归作为计数系统的一部分），因为他们有语言能力。 \citet*[\page 203]{FHC2005a}也这样认为。后者认为在其他领域中的递归的所有形式都取决于语言。关于这点的更多内容，请参考 \citew[\page 7--8]{Chomsky2007a}。 \citet{LL2011a}指出，自然数被界定为递归的，但是数学定义并不必然对人类采用的数学运算发挥重要的作用。
}
