...
\gll Karl hat mir [ein Bild [einer Frau \_$_i$]] gegeben, [die schon lange tot ist]$_i$.\\
	 Karl \textsc{aux} 我  \spacebr{}一 照片  \spacebr{}一 女人 {} 给 \spacebr{}\textsc{rel} PRT 长 死 is\\
...
\gll Karl hat mir [eine Fälschung [des Bildes [einer Frau \_$_i$]]] gegeben, [die schon lange tot ist]$_i$.\\
	Karl \textsc{aux} 我 \spacebr{}一 伪造 \spacebr{}\textsc{prep}.\textsc{det} 照片 \spacebr{}\textsc{prep}.一 女人 {} 给 \spacebr{}\textsc{rel} PRT 长 死 \textsc{cop}\\
...
\gll Karl hat mir [eine Kopie [einer Fälschung [des Bildes [einer Frau \_$_i$]]]] gegeben, [die schon lange tot ist]$_i$.\\
	 Karl \textsc{aux} 我 \spacebr{}一 复制 \spacebr{}\textsc{prep}.一 伪造 \spacebr{}\textsc{prep}.\textsc{det} 照片 \spacebr{}\textsc{prep}.一 女人 {} 给 \spacebr{}\textsc{rel} PRT 长 死 \textsc{cop}\\
...
\gll Ich habe [von [der Vermutung \_$_i$]] gehört, [dass es Zahlen gibt, die die folgenden Bedingungen erfüllen]$_i$.\\
	 我 \textsc{aux} \spacebr{}\textsc{prep} \spacebr{}\textsc{det} 猜测 {} 听说 \spacebr{}\textsc{conj} \expl{} 数字 给 \textsc{rel} \textsc{det} 下面的 要求 满足\\
...
\gll Ich habe [von [einem Beweis [der Vermutung \_$_i$]]] gehört, [dass es Zahlen gibt, die die folgenden Bedingungen erfüllen]$_i$.\\
	我 \textsc{aux} \spacebr{}\textsc{prep} \spacebr{}一 证据 \spacebr{}\textsc{prep}.\textsc{det} 猜测 {} 听说 \spacebr{}\textsc{conj} \expl{} 数字 给 \textsc{rel} \textsc{det} 下面的 要求 满足\\
...
\gll Ich habe [von [dem Versuch [eines Beweises [der Vermutung \_$_i$]]]] gehört, [dass es Zahlen gibt, die die folgenden Bedingungen erfüllen]$_i$.\\
     我 \textsc{aux} \spacebr{}\textsc{prep} \spacebr{}\textsc{det} 尝试 \spacebr{}\textsc{prep}.一 证据 \spacebr{}\textsc{prep}.\textsc{det} 猜测 {} 听说 \spacebr{}\textsc{conj} \expl{} 数字 给 \textsc{rel} \textsc{det} 下面的 要求 满足\\
...
\gll For example, we understand that Ariva buses have won [\sub{NP} a number [\sub{PP} of [\sub{NP} contracts [\sub{PP} for [\sub{NP} routes in London \_$_i$ ]]]]] recently, [which will not be run by low floor accessible buses]$_i$.\\
     \textsc{prep} 例子 我们 理解 \textsc{conj} Ariva 巴士 \textsc{aux} 赢 {} 一 数字 {} \textsc{prep} {} 合同 {} \textsc{prep} {} 路线 \textsc{prep} 伦敦 {} {} 最近 \spacebr\textsc{rel} \textsc{aux} 不 \textsc{aux} 运营 \textsc{prep} 低 层 可及的 巴士\\
...
谁 \textsc{aux} 她 认为 \textsc{conj} 他 看见\\
\glt `她认为他看到的是谁？'
\z
...
谁 \textsc{aux} 她 咕哝 \textsc{conj} 他 看见\\
}
\ex[??]{
...
\gll She realized [\sub{NP} the fact [\sub{S} that he left]].\\
     她   意识到   {}         \textsc{det} 事实 {} \textsc{conj} 他 离开\\
\glt `她意识到他离开了的事实。'
\ex 
...
她 \textsc{aux}.不 低声说 \textsc{conj} 他 离开 {} 他 离开\\
\glt `她没有低声说他离开了。$\to$ 他离开了。 '
\ex 叙实动词\\
%\ex Factive verb\\
\gll She didn't realize that he left. $\to$ He left.\\
她 \textsc{aux}.不 意识到 \textsc{conj} 他 离开 {} 他 离开\\
...
\gll Det$_i$ er   der mange [der kan lide \_$_i$].\\
     \textsc{conj} \textsc{cop} 那  许多 \hspaceThis{[}\textsc{rel} 可以 喜欢\\
...
\textsc{det} 学生 \textsc{prep} 化学 \textsc{aux} 更加 全看 准备 比 \textsc{det} \textsc{pron} \textsc{prep} 物理学\\
...
\gll ``I don't know. I've never seen one up close.''\\
     \hspaceThis{``}Chinese gloss\\
\glt `Chinese translation'
\end{minipage}
\end{tabular}
\z
...
哪儿.\textsc{cop} \textsc{det} 申请表 Mark 承诺 \textsc{inf} 填 \textsc{prep}\\
...
\gll the          application Mark [\sub{\textsc{aux}} PAST] promised to            fill out          [\sub{\textsc{aux}} is] there\\
     \textsc{det} 申请表       Mark {}                  过去]  承诺      \textsc{inf} 填   \textsc{prep} {}                  \textsc{cop} 那儿\\
\glt `Mark过去承诺要填的表在那儿'
}
\ex[*]{
\gll Where did the application Mark promised to fill out is?\\
哪儿 \textsc{aux} \textsc{det} 申请表 Mark 承诺 \textsc{inf} 填 \textsc{prep} \textsc{cop}\\
}
\zl
...
\textsc{aux} 那些 \textsc{rel} \textsc{aux} 来 并且 那些 \textsc{rel} \textsc{aux} 不 来 举起 他们的 手\\
\glt `要来或不来的人请举起手'
}
\z
