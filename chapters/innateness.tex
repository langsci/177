...
句法\isce[|(]{普遍性}{universal}的普遍性被作为论据来证明语言知识的天赋性（如\citet[\page 33]{Chomsky98a-u}、\citet[\page 237--238]{Pinker94a}）。在文献中，对于什么是普遍性的、什么是语言特定的有不同的看法。支持普遍性的突出代表有：\colonfootnote{%
...
许多语言中，介词由动词演变而来。在现代汉语\ilce{现代汉语}{Mandarin Chinese}语法中，有一类词通常被称作副动词\isce{副动词}{coverb}。这些词可以用作介词，也可以用作动词。如果我们历时地观察语言，那么我们就可以找到这些倾向性的解释，而不用参考天赋的语言学知识（参见\citet[\page 445]{EL2009a}）。
...
\citet[第2.2.4节]{EL2009a}讨论了类型学的文献，并且举出了缺少副词和形容词的语言的例子。作者引用了海峡萨利希语（Straits Salish）\ilce{海峡萨利希语}{Straits Salish}作为一种在动词和名词之间没有区别的语言的例子（参见 \citet[\page 481]{EL2009b}）。他们评论说，对于经常使用的排在前四位或前五位的非印欧语系的语言来说，有必要增加额外的词类，如状貌词\isce{状貌词}{ideophone}、方位词\isce{方位词}{positional}、副动词（coverb）\isce{副动词}{coverb}、类别词\isce{类别词}{classifier}等来分析这些语言。\dotfootnote{%
...
在《科学》杂志的一篇文章中， \citet*{HCF2002a}进一步阐明了只有递归才具有具体领域的普遍性，“提供一个有限成分集合生成无限表达的能力”（参见第\pageref{NP-Regeln-Adj}页关于递归的短语结构规则的例子 (\ref{NP-Regeln-Adj})）。\dotfootnote{%
...
哪儿 \textsc{aux} \defart{} 申请表 Mark 承诺 \textsc{inf} 填 \textsc{adv} \textsc{cop}\\
}
\zl
...
哪儿.\textsc{cop} \defart{} 另一个 娃娃  \textsc{rel} \textsc{cop} \textsc{prep} 这儿\\
