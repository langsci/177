...
\end{figure}%
从语言处理的角度来看，具有相同管辖方向的语言更易于被人们接受，因为他们允许听者更好地识别动词短语的组成部分（ \citet[\page 219--221]{Newmeyer2004b}引用了 \citew[\page 32]{Hawkins2004a-u}有关一般处理的偏好的讨论，也可以参考 \citew[\page 131]{Dryer92a}）。这一倾向性就可以这样解释为语言运用偏好的语法化（请看第\ref{Abschnitt-Diskussion-Performanz}章有关语言能力和语言运用的区分），并且与天赋的语言特有的知识是没有关系的。
