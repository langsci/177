...
例如，他们会重复那些没有对动词正确变位的句子。儿童可以从话语被重复以及重复中有变化的事实中推断他们犯了错误，并且Chouinard和Clark也证实了，他们确实是这样做的。作者们观察了五个儿童的数据，他们的父母都有学术背景。他们还讨论了其它文化中父母和子女之间的关系（相关概述请参考 \citew{Ochs82a,OS85a}和 \citew[\page 71]{Marcus93a}），并且涉及了低社会经济阶层的美国家庭的情况（第660页）。
