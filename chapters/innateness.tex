...
在\isc{负向证据|(}\is{negative evidence|(}一些支持天赋语言知识的研究中，他们提出儿童没有接触到负向证据，即没有人告诉他们诸如（\ref{Hilfsverbinversion-ungrammatisch}）\isc{助动词倒装}\is{auxiliary inversion}的句子——这里重复为（\mex{1}）——是不合乎语法的（\citealp[\page 42--52]{BH70a}；\citealp{Marcus93a}）。
