...
\noindent
由Chomsky推进的这个分析是基于转换\isc{转换}\is{transformation}的（请看第\pageref{Seite-GB-Entscheidungsfragen-Englisch}页），也就是说，学习者需要按照Legate和Yang所描述的学习：助动词必须移到主语名词短语的前面。不过，还有其他分析认为不需要变换或其他相当的机制。
