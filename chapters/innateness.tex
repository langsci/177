...
%differences between humans and primates and that these are relevant for linguistic ability.
 \citet{Friederici2009a}对文献进行了综述，并提出，在大猩猩\isc{大猩猩}\is{chimpanzee}和猕猴\isc{猕猴}\is{macaque}（以及儿童）中，大脑各部分之间的连接不如成年人的发达。大脑的相连区域一起负责词汇"=语义知识的处理，并且可以构成语言发展的重要前提（第179页）。
