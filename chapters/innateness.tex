...
238]{Pinker94a}；\citealp[\page 11, 14]{Meisel95a}；\citealp[\page 216]{PJ2005a}）。但是，也有像迪尔巴尔语\ilce{迪尔巴尔语}{Dyirbal}（澳大利亚）这种语言，其中句子无法用层级结构来表示。由此， \citet[\page 110]{Bresnan2001a}认为，\ilce{他加禄语}{Tagalog}、匈牙利语\ilce{匈牙利语}{Hungarian}、马拉雅拉姆语\ilce{马拉雅拉姆语}{Malayalam}、瓦尔皮里语\ilce{瓦尔皮里语}{Warlpiri}、吉瓦里语\ilce{吉瓦里语}{Jiwarli}、万巴亚语\ilce{万巴亚语}{Wambaya}、雅卡语\ilce{雅卡语}{Jakaltek}和其他相应的语言没有VP结点，而是带有（\mex{1}）这样格式的规则：
