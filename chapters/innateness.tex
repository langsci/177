...
这样就需要习得主语是在中心语的左边还是右边实现的信息。除了这个基于词汇的分析，另一种方法是，我们可以采用构式语法\isc{构式语法}\is{Construction Grammar (CxG)}（Fillmore \citeyear[\page44]{Fillmore88a}；\citeyear{Fillmore99a}；\citealp[\page 18]{KF99a}）、认知语法\isc{认知语法}\is{Cognitive Grammar} \citep[\S~9]{Dabrowska2004a}或HPSG理论\indexhpsg \citep{GSag2000a-u}来分析。在这些框架中，只有两个模式\footnote{%
