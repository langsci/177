...
构式语法导向的文献对习得的相关理论作了非常好的论述（请看\ref{Abschnitt-musterbasiert}和\ref{Abschnitt-Selektionsbasierter-Spracherwerb}）。基于构式的习得理论也被我们所能看到的频率效应这样的事实所支持，即，助词变换首先由儿童用在一些助词上，而且只在发展的后期，才扩展到所有的助动词上。如果说话者学会助词构式具有Aux NP
