...
为语言的无限性提供论据的一个可能性是认为只有生成语法\isc{生成语法}\is{Generative Grammar}适合于模拟语言，而且我们需要递归规则来捕捉语言事实，这就是为什么心智表达式具有递归机制，从而生成无限数量的表达式（Chomsky, \citeyear[\page 115]{Chomsky56a-u}；\citeyear[\page
