...
除此之外，也可以观察到，大脑的某些部位在阅读时会被激活。如果在大脑的某些部位处理的定位导致语言知识的天赋机制是有效的，那么在阅读时，大脑某些部位的激活就会让我们得出这样的结论，阅读的能力是天赋的（\citealp[\page ]{EBJKSPP96a}；\citealp[\page 57]{Bishop2002a}）。但是，并没有这样假设（也请参考\citealp*[\page 196]{FHC2005a}）。
