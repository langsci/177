...
\gll Det    hus$_i$  kender jeg en    mand [som har købt \_$_i$].\\
     \textsc{det}   房子  认识  我 一 男人 \hspaceThis{[}\textsc{conj} \textsc{aux} 买\\
\glt `我认识一个买了那栋房子的人。' (直译: `这个房子，我认识一个买了它的人。')
...
\textsc{aux} 那些 \textsc{rel} \textsc{aux} 来 和 那些 \textsc{rel} \textsc{aux} 不 来 举起 他们的 手\\
\glt `来的和不来的能举起手吗？'
}
\z
...
生成
\hfill\mbox{}
\caption{\label{Abbildung-Analyse}应用图\ref{Abbildung-Teilbaume}中的子树的“The dog barks”的分析}
