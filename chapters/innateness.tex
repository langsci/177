...
\zl
Chomsky表示，儿童没有任何证据说明这样的事实，简单地把第一个助动词线性地提前是错的，这就是为什么他们可以按照数据驱动的学习过程来验证这个观点。他甚至进一步提出，操英语者只是很少，甚至是从未生成过（\ref{Hilfsverbinversion-mit-RS}）这样的例子（ \citew[\page 114--115]{Piattelli-Palmarini80a-u}）。
