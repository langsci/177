...
\gll Ich habe [von [einem Beweis [der Vermutung \_$_i$]]] gehört, [dass es Zahlen gibt, die die folgenden Bedingungen erfüllen]$_i$.\\
	我 \textsc{aux} \spacebr{}\textsc{prep} \spacebr{}一 证据 \spacebr{}\textsc{prep}.\textsc{det} 猜测 {} 听说 \spacebr{}\textsc{conj} \expl{} 数字 给 \textsc{conj} \textsc{det} 下面的 要求 满足\\
...
\gll Ich habe [von [dem Versuch [eines Beweises [der Vermutung \_$_i$]]]] gehört, [dass es Zahlen gibt, die die folgenden Bedingungen erfüllen]$_i$.\\
     我 \textsc{aux} \spacebr{}\textsc{prep} \spacebr{}\textsc{det} 尝试 \spacebr{}\textsc{prep}.一 证据 \spacebr{}\textsc{prep}.\textsc{det} 猜测 {} 听说 \spacebr{}\textsc{conj} \expl{} 数字 给 \textsc{conj} \textsc{det} 下面的 要求 满足\\
...
\gll Der 43jährige will nach eigener Darstellung damit [\sub{NP} den Weg [\sub{PP}~für [\sub{NP} eine
  ...
  \textsc{det} 43岁 想要 \textsc{prep} 自己的 描述 那儿.\textsc{prep} {} \textsc{det} 道路 \hspaceThis{[\sub{PP}~}\textsc{prep} {} 一 讨论 {} 关于 {} \textsc{det} 未来 路线 {} \textsc{prep}.\textsc{det} 强
...
\gll {}[\ldots] die Erfindung der Guillotine könnte [\sub{NP} die Folge [\sub{NP} eines verzweifelten
    ...
    {}  \textsc{det} 发明 \textsc{prep}.\textsc{det} 断头台 \textsc{aux} {} \textsc{det} 结果 {} \textsc{prep}.一 绝望 尝试 \textsc{det} 相同.名字 医生 \textsc{aux} \textsc{aux} \spacebr{}他的 病人
...
\textsc{prep} 例子, 我们 理解 \textsc{conj} Ariva 巴士 \textsc{aux} 赢 [\sub{NP} 一 数字 [\sub{PP} \textsc{prep} [\sub{NP}
...
我 拾 起 [\sub{NP} 一 复印本 \textsc{prep} [\sub{NP} 一 书 \_$_i$ ]] 今天, \textsc{prep} 一 法律
...
我们 起草 [\sub{NP} 一 列表 \textsc{prep} [\sub{NP} 基本 需求 \_$_i$ ]] 那 晚上 [\textsc{conj} \textsc{aux} \textsc{inf} \textsc{aux}
...
\gll Det    hus$_i$  kender jeg en    mand [som har købt \_$_i$].\\
     \textsc{conj}   房子  认识  我 一 男人 \hspaceThis{[}\textsc{conj} \textsc{aux} 买\\
...
我.\textsc{aux} 更 教 语言学 \textsc{inf} 一 学生 \textsc{prep} 数学 比 \textsc{inf} PRON \textsc{prep}  任何 专业 \textsc{prep} \textsc{det} 人文学科\\
...
一 支持者 \textsc{prep} Linux 卷 进 一 热烈的 讨论 \textsc{prep} PRON \textsc{prep} Windows NT 和 \textsc{det} 剩余的 \textsc{prep} \textsc{det} 晚上 \textsc{aux} 书呆子 谈话\\
...
\textsc{aux} [\textsc{det} 人 \textsc{conj} \textsc{aux} 读 一 书] e 吃 晚饭\\
\glt `看书的那个人吃晚饭了吗？'
\end{xlist}
\end{exe}
\end{quote}
