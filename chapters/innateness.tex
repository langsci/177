...
在乔姆斯基式理论的后期，也有一些看起来对应于语法功能的功能性结点（AgrS\isce{范畴!功能!AgrS}{category!functional!AgrS},
AgrO\isce{范畴!功能!AgrO}{category!functional!AgrO}, AgrIO\isce{范畴!功能!AgrIO}{category!functional!AgrIO}，参见第\pageref{Seite-AgrO}页）。但是， \citet[\S~4.10.1]{Chomsky95a-u}指出，这些功能性范畴只是出于理论内部的原因而提出的，而且应该被排除在普遍语法的范畴之外。参见 \citew{Haider97a}和 \citew[\page 509--510]{Sternefeld2006a-u}对德语的描写，其中无功能性的投射无法在该语言中被驱动。
...
跟克里奥尔语一样，我们可以在手语\isce{手语}{sign language}习得的某些社会环境中找到类似的情境： \citet{SN2004a}的研究显示，一个学习美国手语（ASL）\iscesub{手语}{sign language}{美国手语}{American (ASL)}的孩子（Simon）比他的父母犯的错误少很多。他的父母是在15或16岁时第一次学习美国手语的，并且只在70\%的时间才执行特定的规定性动作。而Simon则90\%的时间都做了这些动作。他把从他的父母那里得到的输入规范化了，其中形式-意义对儿的持续使用发挥了重要的作用，也就是说，他没有简单地使用概率匹配，而是有选择地学习。 \citet[\page 401]{SN2004a}怀疑，这种规范化在克里奥尔语和手语的涌现过程中也起到了重要作用。但是，我们还没有可以证明这个假说的相关统计学数据。
