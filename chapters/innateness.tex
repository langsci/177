...
%see  \citew{FM2005a}.
 ...
 \citet{MMGRRBW2003a}考察了第二语言习得中的大脑活动。他们给德语母语者提供意大利语\il{Italian}和日语\il{Japanese}的语料，然后发现布洛卡区被激活。然后，他们将这种情况与用意大利语和日语词的人工语言进行对比，这些语言并不符合作者提出的普遍语法的原则。比如说，他们的人工语言的处理包括例（\mex{1}）中显示的调换语序的问句。
