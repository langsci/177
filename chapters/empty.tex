...
\gll Den Aufsatz$_i$ liest$_j$ er [nicht t$_i$ t$_j$].\\
	\textsc{det} 散文 读 他 \spacebr{}\textsc{neg}\\
\glt `他现在没有读这篇散文。'
%\gll Den Aufsatz$_i$ liest$_j$ er [nicht t$_i$ t$_j$].\\
...
\gll Lesen$_i$ wird$_j$ er ihn [nicht t$_i$ t$_j$].\\
	 读 \textsc{aux} 他 它 \spacebr{}\textsc{neg}\\
\glt `他不会读它。'
%\gll Lesen$_i$ wird$_j$ er ihn [nicht t$_i$ t$_j$].\\
...
\gll dass Max alle Fenster wieder öffnete\\
	 \textsc{conj} Max \textsc{det} 窗户 再次 打开\\
\glt `Max再次打开所有窗户这件事'
%\gll dass Max alle Fenster wieder öffnete\\
...
\gll dass Max wieder alle Fenster öffnete\\
    \textsc{conj} Max 再次 \textsc{det} 窗户 打开\\
%\gll dass Max wieder alle Fenster öffnete\\
...
\gll dass Max alle Fenster öffnete\\
	 \textsc{conj} Max \textsc{det} 窗户 打开\\
\glt `Max打开所有这些窗户'
%\gll dass Max alle Fenster öffnete\\
...
\caption{“Max alle Fenster öffnete”的支配图\label{Abbildung-Max-alle-Fenster-oeffnete}}
...
%\end{sideways}
\caption{\label{Abbildung-Fenster-oeffnete-MRS}“alle Fenster öffnete”的MRS分析}
...
\gll [dass] Peter den Teich leer fischt\\
	 \spacebr{}\textsc{conj} Peter \textsc{det} 池塘 空 钓\\
