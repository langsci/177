...
我们很容易接受以下事实：我们的大脑无法处理超过一定复杂度的结构，并且相应的语句就会变得无法接受。下面例子中的对比更为明显：\dotfootnote{%
...
从现有的讨论中，我们可以得出什么结论？是否有进一步的数据可以帮助确定一个理论应该具有什么属性以保障在心理语言学层面的有效性？ \citet*{SWB2003a}和 \citet{SW2011a,SW2015a}列出了以下几个跟语言运用兼容的语言能力语法应该具有的属性：\dotfootnote{%
