...
\gll (the rat (the cat (the dog chased) killed) ate the malt)\\
     \textsc{det} 老鼠 \textsc{det} 猫 \textsc{det} 构 追逐 杀死 吃 \textsc{det} 麦芽\\
...
\gll dass der Hund bellt, der die Katze jagt, die die Maus kennt, die im Keller lebt\\
    REL \textsc{det} 狗.\mas{} 叫 REL.\mas{} \textsc{det} 猫 追逐 REL.\fem{} \textsc{det} 老鼠 知道 REL \textsc{prep}.\textsc{det} 地下室 居住\\
...
\gll dass er Hund, [$_1$ der die Katze, [$_2$ die die Maus, [$_3$ die im Keller lebt,  $_3$] kennt, $_2$] jagt $_1$] bellt\\
     REL \textsc{det} 狗 {} REL \textsc{det} 猫 {} REL \textsc{det} 老鼠      {}    REL \textsc{prep}.\textsc{det} 地下室 居住 {} 知道 {} 追逐 {} 叫\\
%\gll dass er Hund, [$_1$ der die Katze, [$_2$ die die Maus, [$_3$ die im Keller lebt,  $_3$] kennt, $_2$] jagt $_1$] bellt\\
...
\textsc{det} 长凳 {} \textsc{prep} REL 后面.然后 \textsc{det} 老.人 \textsc{prep}.\textsc{det} 村庄 {} REL 所有的 儿童 {} REL 来.\textsc{prep} {} 友好地 一瞥 给 {}
长 小时 安静的 紧邻的.\textsc{prep}.每一个.另外的 坐 {} \textsc{aux} \textsc{prep}.\textsc{det} 上个 年 \textsc{art} 汽车.停车场 给.路.\textsc{prep}\\
...
\gll The patient [ who the nurse [ who the clinic had hired ] admitted ] met Jack.\\
    \textsc{det} 病人 REL \textsc{det} 护士 REL \textsc{det} 诊所 \textsc{aux} 雇佣 允许 看 Jack\\
...
\gll The patient who the nurse who the clinic had hired met Jack.\\
    \textsc{det} 病人 REL \textsc{det} 护士 REL \textsc{det} 诊所 \textsc{aux} 雇佣 看 Jack\\
...
\gll John phoned up the girl.\\
    John 打电话 \textsc{prep} \textsc{det} 女孩\\
\glt `John给那个女孩打电话。'
%\ex John phoned up the girl.
\ex 
\gll John phoned the girl up.\\
    John 打电话 \textsc{det} 女孩 \textsc{prep}\\
\glt `John给那个女孩打电话。'
...
\gll The bus driver was fired after the wreck.\\
    \textsc{det} 公共汽车 司机 \textsc{cop} 被解雇 \textsc{det} 车祸\\
\glt `公共汽车司机在车祸之后被解雇了。'
...
\gll The horse raced past the barn fell.\\
    \textsc{det} 马 跑 \textsc{prep} \textsc{det} 粮仓 倒下\\
...
\gll The horse raced past the barn.\\
    \textsc{det} 马 跑 \textsc{prep} \textsc{det} 粮仓\\
\glt `那匹马跑过了粮仓。'
...
\gll The horse that was raced past the barn fell.\\
    \textsc{det} 马 REL \textsc{cop} 跑 \textsc{prep} \textsc{det} 粮仓 倒下\\
\glt `被赶过粮仓的马倒下了。'
%\ex The horse that was raced past the barn fell.
\ex 
\gll The boat that was floated down the river sank.\\
    \textsc{det} 船 REL \textsc{cop} 漂浮 \textsc{prep} \textsc{det} 河 沉\\
\glt `沿河水顺流而下的船沉没了。'
...
\gll The horse that they raced around the track held up fine. The horse that was raced down the road faltered a bit. And the horse raced past the barn fell.\\
    \textsc{det} 马 REL 他们 跑 \textsc{prep} \textsc{det} 轨道 握住 \textsc{prep} 好 \textsc{det} 马 REL \textsc{cop} 跑 \textsc{prep} \textsc{det} 颤抖漂浮 \textsc{prep} \textsc{det} 河 沉\\
\glt `沿河水顺流而下的船沉没了。'
...
\gll The evidence examined by the judge turned out to be unreliable.\\
    \textsc{det} 证据 检查 \textsc{prep} \textsc{det} 法官 转变 \textsc{prep} \textsc{prep} \textsc{cop}  不可信\\
\glt `被法官检查的证据变得不可信了。'
...
残废的 银行.系统 \textsc{prep}.\textsc{det} 国家 \textsc{prep}.最少 200 亿 英镑 \textsc{prep} 使用\\
