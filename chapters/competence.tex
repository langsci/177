...
\textsc{det} 长凳 {} \textsc{prep} \textsc{rel} 那时 \textsc{det} 老.人 \textsc{det} 村庄 {} \textsc{rel} 所有 儿童 {} \textsc{rel} 路过 {} 友好地 一瞥 给 {}
长 小时 安静的 并排 坐 {} \textsc{aux} \textsc{prep}.\textsc{det} 上个 年 一 停车场 让路\\
\glt `那些过去常常友好地看着所有路过的孩子，过去常常安静地并排坐好几个小时的小村庄的老居民所坐的长椅不得不在去年让位于停车场。'
%\gll Die Bänke, [$_1$ auf denen damals die Alten des Dorfes, [$_2$ die allen Kindern, [$_3$ die vorbeikamen $_3$], freundliche Blicke zuwarfen $_2$], 
%lange Stunden schweigend nebeneinander saßen $_1$], mussten im letzten Jahr einem~~~~~~~~ Parkplatz weichen.\\
...
\gll The bus driver was fired after the wreck.\\
    \textsc{det} 公共汽车 司机 \textsc{cop} 解雇 \textsc{prep} \textsc{det} 车祸\\
\glt `公共汽车司机在车祸之后被解雇了。'
...
\glt `沿着跑道跑的马跑得很好。沿着小路跑的马跑得有点不稳。而跑过谷仓的马跌倒了。'
...
残废的 银行.系统 \textsc{det} 国家 至少 200 亿 英镑 \textsc{inf}.\textsc{det} 使用\\
...
{}\spacebr{}{}\spacebr{} 什么 {} \textsc{aux} {} Ann {}\spacebr{}{}\spacebr{}{}\spacebr{}{}\spacebr{}{}\spacebr{}{}\spacebr{} 读\\
\glt `Ann将会读什么？'
\z
