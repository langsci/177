...
与Haegeman观点相反的是\citet[\S~1.6.2]{Croft2001a}提出了支持平铺结构。在其\indexcxg 激进构式语法（Radical Construction Grammar）FAQ中，Croft注意到像（\mex{1}a) 中所示的短语构式可以被转换成（\mex{1}b）所指的范畴语法的词项\indexcg。
