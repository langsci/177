...
如果我们考虑个别框架的新发展，所提出分析的本质有时会有很大差异就变得清楚了。而CG、LFG、HPSG和CxG都是表层导向的，有时在最简方案中会提出非常抽象的结构，而在有些情况下，有人试图将所有语言都归结于一个基本结构（普遍性本质假说\isc{普遍性本质假说}\is{Universal Base Hypothesis}）\footnote{%
