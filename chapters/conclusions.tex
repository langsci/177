...
290--291]{SE2002a}主张在最简方案\indexmpc 中使用特征值偶对。同样，参见 \citet{Veenstra98a}使用类型特征描写构建的基于约束的最简分析。依存语法的变体，如Hellwig的依存合一语法\isce{依存合一语法}{Dependency Unification Grammar (DUG)}，也使用了特征值偶对\citep[\page 612]{Hellwig2003a}。
