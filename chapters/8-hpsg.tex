...
\noindent
我们可以将\argstlc 视为等同于\gbc 理论的深层结构\isc{深层结构}\is{Deep Structure}：语义角色按照这个列表来指派。区别在于这里没有经历了转换过程\isc{转换}\is{transformation}的有序树。这样，所有的语言是从VO还是OV的语序生成而来的问题就变成无关的了。
