...
\zl
尽管（\mex{0}a）的英文译文是合乎语法的，因为knows和helps都带一个宾格宾语，而（\mex{0}a）本身是不合乎语法的，因为kennt带一个宾格宾语，而hilft带一个与格宾语。相似地，（\mex{0}b）也是不合乎语法的，因为kennt带一个宾格宾语，而wartet带一个包括介词auf的介词短语。
