...
\begin{quotation}
HPSG在实际的实现中，解决问题的典型办法是引导语言处理器运用一个（基于规则的）短语结构骨架，但是该方法的缺点在于“语法的组织和形式化与语言学理论不一致”\citep[第4.2.2节]{LM2006a}。\citep[\page 108]{vanTrijp2013a}\bracketfootnotequote{%
...
由于三种理论的来源不同，各自的分析差异可能很大：HPSG是一个强词汇化理论，在该理论中短语统制模式只是近十年在Ivan Sag \ia{Sag, Ivan A.}的影响下才不断增多。Ivan Sag在他文章中所用的短语统制模式基本上是早期版本HPSG中模式的修正。重要的是，所有与价互动的现象都接受了一种词汇分析\citep*[第2.3节]{SBK2012a}。另一方面，在CxG中，主要的基于短语的分析都是受到Adele Goldberg\ia{Goldberg, Adele E.}的影响才被接受的。
