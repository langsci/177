...
那么，两个二叉结构的变体都被排除了，只剩下了扁平结构分析。基于符号的CxG，是HPSG的一个变体\citep[\page 486]{Sag2010b}，以及体验构式语法 \citep[\page 156]{BC2005a}允许直接支配\iscesub{支配}{dominance}{直接支配}{immediate}和线性次序\isce{线性次序}{linear precedence}的分离，所以可以为及物动词设置一个构式，这对应于（\mex{1}）所示的统制规则：\footnote{%
