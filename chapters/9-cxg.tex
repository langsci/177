...
\gll Der Weltmeister wird (von ihm) geschlagen.\\
	 \textsc{det} 世界.冠军 \textsc{cop} \spacebr{}\textsc{prep} 他 打\\
\glt `世界冠军正在（被他）打。'
%\ex 
%\gll Er schlägt den Weltmeister.\\
...
\gll aussehen, als hätten X\_Dat die Hühner das Brot weggefressen\\
	 看 好像.如果 \textsc{aux} X \textsc{art} 鸡肉 \textsc{art} 面包 \textsc{prep}.吃\\
\glt `看起来很疑惑/迷惑'
%\gll aussehen, als hätten X\_Dat die Hühner das Brot weggefressen\\
...
看 好像 如果 黄油 \textsc{aux}.NEG 融化 [\textsc{prep} X的 嘴巴]
\glt '看起来好像完全无辜'
...
\gll Justin Bieber—Once upon a time ∅ butter wouldn't melt in little Justin's mouth. Now internationally famous for being a weapons-grade petulant brat\\    %\ldots
     Justin Bieber—一次 \textsc{prep} \textsc{art} 时间 ∅ 黄油 \textsc{aux}.NEG 融化 \textsc{prep} 小 Justin的 嘴 现在 国际的 著名 \textsc{prep} \textsc{cop} \textsc{art} 武器-级别 易怒的 小孩\\
...
\gll ich glaub es tritt mich ein Pferd wenn ich einen derartigen Unsinn lese.\footnotemark\\
     我 相信 \expl{} 击打 我 \textsc{art} 马 REL 我 \textsc{art} \textsc{det} 胡说 读\\
\footnotetext{
...
\gll omg dieser xBluuR der nn ist wieder da ey nein ich glaub es tritt mich ein Pferd!!\footnotemark\\
    omg\textsc{det}   XBluuR 他  {} \textsc{cop}  再次 这里 {} NEG 我 相信 \expl{} 击打 我 \textsc{art} 马\\
\footnotetext{
...
%\addlines[2]
在非局部依存中设置共享信息的另一个好处是通过指派一些信息在共享信息之外来排除这些信息。这种做法曾被\citet{Hoehle94a}、\citet{Mueller96a,Mueller2002b}和\citet{Meurers99a}用于解释德语中的部分动词短语前置现象。德语中部分动词短语前置是指动词可以跟一些或所有宾语一起前置，即使该动词在其它环境中不形成VP。例如，（\mex{1}a） 中的erzählen（告诉）和wird（将要）通常构建一个复杂短语，这一短语不能通过将erzählen（告诉）的投射置换到左边而分开。
...
\gll  dass er seiner Tochter ein Märchen erzählen wird\\
      REL 他 他的 女儿 \textsc{art} 仙女.故事 告诉 \textsc{aux}\\
...
\gll dass er seiner Tochter ein Märchen erzählen nie wird\\
     REL 他 他的    女儿 \textsc{art} 仙女.故事 告诉 NEG \textsc{aux}\\
%\gll dass er seiner Tochter ein Märchen erzählen nie wird\\
...
\gll Ein Märchen        erzählen wird er       seiner Tochter.\\
     \textsc{art}   童话.\acc{} 告诉      \textsc{aux} 他.\nom{} 他的.\dat{}    女儿\\
%\gll Ein Märchen        erzählen wird er       seiner Tochter.\\
...
\gll Seiner Tochter        ein Märchen        erzählen wird er.\\
     他的.\dat{}    女儿 \textsc{art}.\acc{}   童话 告诉      \textsc{aux} 他.\nom\\
%\gll Seiner Tochter        ein Märchen        erzählen wird er.\\
...
\gll The letter was sent to her.\\
     \textsc{art} 信 \textsc{cop} 寄送 \textsc{prep} 她\\
\glt `这封信被寄送给她了。'
...
\gll The kennel     which Mary made and Fido sleeps in has been stolen.\\   \jambox{(= S/NP \& S/NP)}
    \textsc{art}  狗窝 REL Mary 做 并且 Fido 睡 \textsc{prep} \textsc{aux} \textsc{cop} 偷\\
...
\gll The kennel in which Mary keeps drugs and Fido sleeps has been stolen.\\   \jambox{(= S/PP \& S/PP)}
    \textsc{art}  狗窝 \textsc{prep} REL Mary 保持 药物 并且 Fido 睡 \textsc{prep} \textsc{aux} \textsc{cop} 偷\\
...
\gll The kennel (in) which Mary made and Fido sleeps has been stolen.\\     \jambox{(= S/NP \& S/PP)}
    \textsc{art}  狗窝 \textsc{prep} REL Mary 做 并且 Fido 睡 \textsc{prep} \textsc{aux} \textsc{cop} 偷\\
}
\zl
...
\gll Dieses Buch hat der Mann mir versprochen, seiner Frau zu geben, der gestern hier aufgetreten ist.\\
     这   书 \textsc{aux} \textsc{det} 男人  我  承诺     他的    妻子 \textsc{prep} 给   REL 昨天 这里 演奏 \textsc{cop}\\
...
\gll I am waiting for my man.\\
    我 \textsc{cop} 等待 \textsc{prep} 我的 人\\
\glt `我在等待我的人。'
