...
对于SBCG的推崇者来说，有两个可能的结论：或者放弃\motherfc，因为同意不作出错误预测的理论就是受到充分限制的，并且不需要明确说明语言中什么是不能出现的；或者人们必须对音系值非局部选择的问题作出反应，并且因此要假设\synsemc 或者\localfc 值，这两个值可以捆绑对于提升和非局部依存有用的信息，另外还不能包括音系特征。\dotfootnote{%
