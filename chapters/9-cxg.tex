...
\gll The kennel     which Mary made and Fido sleeps in has been stolen.\\   
    \textsc{art}.\textsc{def}  狗窝 \textsc{rel} Mary 做 并且 Fido 睡 \textsc{prep} \textsc{aux} \passivepst{} 偷\\\jambox{(= S/NP \& S/NP)}
...
\gll The kennel in which Mary keeps drugs and Fido sleeps has been stolen.\\   
    \textsc{art}.\textsc{def}  狗窝 \textsc{prep} \textsc{rel} Mary 保持 药物 并且 Fido 睡 \textsc{aux} \passivepst{} 偷\\\jambox{(= S/PP \& S/PP)}
...
\gll The kennel (in) which Mary made and Fido sleeps has been stolen.\\     
    \textsc{art}.\textsc{def}  狗窝 \hspaceThis{(}\textsc{prep} \textsc{rel} Mary 做 并且 Fido 睡 \textsc{aux} \passivepst{} 偷\\\jambox{(= S/NP \& S/PP)}
}
\zl
