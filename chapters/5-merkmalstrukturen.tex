...
%\mynode{printer}{\type{printer}}   & \mynode{\textsc{cop}y}{\type{photo\textsc{cop}ier}}  & \mynode{scanner}{\type{scanner}}\\[6ex]
...
%\type{printing device} can produce information and a \type{scanning device} can read in information. A \type{photo\textsc{cop}ier} can both produce %information and read it. Photo\textsc{cop}iers have both the properties of scanning and printing devices.
%This is expressed by the connection between the two superordinate types and \type{photo\textsc{cop}ier} in
...
%for \type{printer} $\vee$  \type{photo\textsc{cop}ier}, one can simply write \type{printing device} if one assumes the type hierarchy in Figure~\vref{fig-%electric-appliance}.%
