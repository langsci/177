...
普遍认为，两个对象可以被组合起来 \citep[\page 226]{Chomsky95a-u}。对于移位来说，一个给定的移位操作一定会有一个动因。这个移位的原因被认为是可以核查它要移到的位置上的某些特征\isce{特征核查}{feature checking}
...
针对Kayne模型的争论，参见 \citew{Haider2000a}。Haider指出，Kayne类的理论对德语作出了不正确的判断（比如说对于选择的副词和第二谓词的位置，以及动词的复杂构成），由此就无法证明该理论可以解释所有的语言的论断。 \citet[\S~4]{Haider97a}指出，由 \citet{Pollock89a-u}、 \citet{Haegeman95a-u}和其他人提出的空否定\isce{范畴!功能!Neg}{category!functional!Neg}中心语的论断是有问题的。参见 \citew{Bobaljik99a}关于Cinque的副词投射的论断的讨论。
...
最后，对于特征驱动的移位来说有一个概念上的问题，这一问题由Gisbert Fanselow指出：\mbox{} \citet[\page 27]{Frey2004a}\isce[|(]{话题}{topic}\isce[|(]{焦点}{focus}\isce[|(]{信息结构}{information structure}提出了KontrP\isce{范畴!功能!Kontr}{category!functional!Kontr}（对比短语），并且 \citet{Frey2004b-u}还提出了TopP\isce{范畴!功能!Top}{category!functional!Top}（话题短语）（参见 \citew{Rizzi97a-u}提出的意大利语\ilce{意大利语}{Italian}的TopP和FocP\isce{范畴!功能!Foc}{category!functional!Foc}（焦点短语）、 
