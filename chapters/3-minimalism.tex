...
\glt `百吉饼，我喜欢吃，但是Ellison不喜欢吃。'\footnote{%
   \citew[\page 205]{ps2}。
}
\ex 
...
\gll Der          Mann, der         behauptet hat,         dass          Maria gelacht hat,         steht neben        der          Palme, die im letzten Jahr gepflanzt wurde.\\
     \textsc{det} 男人  \textsc{rel} 声称      \textsc{aux} \textsc{comp} Maria 大笑     \textsc{aux} 站   \textsc{prep} \textsc{det} 棕榈树 \textsc{rel} \textsc{prep}.\textsc{det} 上次 年 种植 \textsc{aux}\\
