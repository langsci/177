...
%}
\citet[\page 147]{Chomsky95a-u}\label{Seite-AgrO}采纳了 \citet{Pollock89a-u}的观点，并认为所有语言都有主宾一致关系\iscesub{一致关系}{agreement}{宾语}{object}和否定（AgrS\iscesubsub{范畴}{category}{功能}{functional}{AgrS}{AgrS}、AgrO\iscesubsub{范畴}{category}{功能}{functional}{AgrO}{AgrO}、Neg\iscesubsub{范畴}{category}{功能}{functional}{Neg}{Neg}）的功能投射。\footnote{%
...
\zllast
}，没有对多重一致关系的处理\isce{一致关系}{agreement} \citep[\S~27.4.3]{Stabler2010b}，尤其是没有语义\isce{语义}{semantics}。PF和LF的过程也没有被模拟。\footnote{%
