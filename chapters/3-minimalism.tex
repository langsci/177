...
\gll dass der Mann das Buch gelesen hat\\
     \textsc{conj} \textsc{det} 人  \textsc{det} 书 读 \textsc{aux}\\
\glt `这个人读这本书'
...
某人 谁 我们 不 认识 刚 走 进 \textsc{det} 房间\\
\glt `我们不认知的某个人刚走进房间'
\z
...
\textsc{aux} 总是 \textsc{aux} 她 \textsc{det} 肉\\
\glt `她并不总是把肉调味。'
\zl
...
\gll dass die Polizei gestern Linguisten verhaftete\\
	 \textsc{conj} \textsc{det} 经常 昨天 语言学家 逮捕\\
\glt `昨天警察逮捕了语言学家'
...
\gll dass die Polizei Linguisten gestern verhaftete\\
	 \textsc{conj} \textsc{det} 警察 语言学家 昨天 逮捕\\
\glt `昨天警察逮捕了语言学家'
...
\gll {}[\emph{Wessen}      Birne]    noch halbwegs in der Fassung steckt, pflegt solcherlei Erloschene zu meiden;\footnotemark\\
       \hspaceThis{[}谁的 灯泡/头 也  半路  \textsc{prep} \textsc{det} 插座  \textsc{aux}      使用  这样      消逝    INF 避免\\
...
\gll {}[\emph{Wessen} Schuhe] "`danach"'  besprenkelt sind, hat keinen Baum gefunden und war nicht zu einem Bogen in der Lage.\footnotemark\\
       \hspaceThis{[}谁的    鞋   此后 有斑点的    \textsc{aux}   \textsc{aux} 不     树 找到    和 \textsc{aux} 不   INF \textsc{art}     弓   \textsc{prep} \textsc{det} 位置\\
...
他 尝试 INF 劝说 但是 \textsc{aux}-NEG 说服 他\\
}
\zl
...
\textsc{det} 男人 \textsc{conj}$_i$ Mary 爱 \_$_i$ 和 Sally 恨 \_$_i$ 计算 我的 税\\
...
\textsc{prep} 没有 条件 \emph{\textsc{aux} 她 想 他们 \textsc{aux} 做 那}\\
...
\gll Der Mann, der behauptet hat, dass Maria gelacht hat, steht neben der Palme, die im letzten Jahr gepflanzt wurde.\\
      \textsc{det} 男人 \textsc{conj} 声称 \textsc{aux} \textsc{conj} Maria 大笑 \textsc{aux} 站 \textsc{prep} \textsc{det} 棕榈树 \textsc{conj} \textsc{prep} 上次 年 种植 \textsc{aux}\\
