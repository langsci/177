...
\zl
如果借助树结构来分析约束和NPI现象的话，就需要让反身代词在句法树上的位置高于专有名词Benjamin。更准确地说，反身代词himself必须c-统制Benjamin。c-统制的定义如下所示\citep[\page 117]{Adger2003a}：\dotfootnote{%
...
除此之外，那些认为与词组合并的句法对象是限定语的分析不允许两个动词直接并列，如\pmex{1}所示：\dotfootnote{\label{fn-Chomsky-on-Specifiers}%
...
Stabler将内部合并界定为：\dotfootnote{\label{Fn-SMC}%
