...
\gll {}[\emph{Wessen}     Schuhe] "`danach"'  besprenkelt sind, hat keinen Baum gefunden und war nicht zu einem Bogen in der Lage.\footnotemark\\
       \hspaceThis{[}谁的  鞋      \hspaceThis{"`}此后 有斑点的    \textsc{aux}   \textsc{aux} 不     树 找到    和 \textsc{cop} 不   \textsc{prep} \textsc{art}     弓   \textsc{prep} \textsc{det} 位置\\
...
\gll {}[[gave John] a book]\\
       \hspaceThis{[[}给 John \textsc{art} 书\\
\glt `给John一本书'
\ex\label{ex-gave-john-a-book-b} 
\gll {}[gave John a book]\\
       \spacebr{}给 John \textsc{art} 书\\
\glt `给John一本书'
\zl
