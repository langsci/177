...
在\ref{sec-passive-gb}\isce{范畴!功能!v@\textit{v}|(}{category!functional!v@\textit{v}|(}中，我用\xbarc 结构来表示双及物动词，该动词带上宾格宾语构成一个\vbarc，然后跟与格宾语构成一个\vbarc。这种动词带宾语构成\vbarc 的二元结构以及平铺结构的分析未被许多GB理论和最简方案的实践者所采纳，因为反身代词与否定极项的约束现象并不兼容这些分支结构。
...
\isce{范畴!功能!v@\textit{v}|)}{category!functional!v@\textit{v}|)}
...
移位必须由特征核查所允准这一思想导致了（静态）功能中心语数量的膨胀\isce{范畴!功能|(}{category!functional|(}。\footnote{%
...
\isce{范畴!功能|)}{category!functional|)}\isce[|)]{信息结构}{information structure}\isce[|)]{附加语}{adjunct}
...
它对一价动词\isce{动词!一价|(}{verb!monovalent|(}的处理是不正确的。如果动词与DP组合，按照\pref{Definition-EM}中有关外部合并的定义，就会将DP看作是补足语\footnote{%
