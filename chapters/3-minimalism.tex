...
进而，还需要指出SubjP和ObjP、TraP\iscesubsub{范畴}{category}{功能}{functional}{Tra}{Tra}（及物短语）和IntraP\iscesubsub{范畴}{category}{功能}{functional}{Intra}{Intra} （不及物短语）（\citealp[\page 1745]{Karimi-Doostan2005a}）和TopP\isc{范畴}{category}{功能}{functional}{Top}{Top} （话题短语）、DistP\iscesubsub{范畴}{category}{功能}{functional}{Dist}{Dist} （数量短语）、AspP\iscesubsub{范畴}{category}{功能}{functional}{Asp}{Asp} （情态短语） （\citealp[\page 22]{EKiss2003a-u}；\citealp[\page 35]{Karimi2005a}）、PathP\iscesubsub{范畴}{category}{功能}{functional}{PathP}{PathP}和PlaceP\iscesubsub{范畴}{category}{功能}{functional}{PlaceP}{PlaceP}\citep[\page 246]{Svenonius2004a-u}这些范畴符号都包含了语法功能\isce{语法功能}{grammatical function}、配价、信息结构和语义的信息。\footnote{%
...
%% adjectives. 
诸如范畴语法和中心语驱动的短语结构语法这样的理论可以将词汇项直接组合，无须假定任何助动词投射或空成分。参见 \citew{Rauh2016a}有关早期的转换语法、中心语驱动的短语结构语法\indexhpsgc、构式语法\indexcxgc、角色与参照语法\isc{角色与参照语法}\is{Role and Reference
...
%\z
%\end{figure}%
等号的位置决定了论元需要实现在中心语的哪一边。这对应于范畴语法的前向\isce{前向应用}{forward application}与后向应用\isc{后向应用}\is{backward
...
\isc{最简方案（MP）}\is{Minimalist Program (MP)}
