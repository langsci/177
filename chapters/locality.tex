...
可以跨越短语边界指派格的动词叫做ECM动词，其中，ECM表示例外格标记（Exceptional Case Marking，简称ECM）\isc{例外格标记（ECM）}\is{Exceptional Case Marking (ECM)}。正如名称所示，这种向短语中进行格指派被看作是一种例外。在这一理论的最新版本中（\egc \citealp[\page 120--123]{Kratzer96a}），所有格都可以指派到限定语位置。例如，图\vref{Abbildung-Kratzer}的Voice\isce{范畴!功能!态}{category!functional!Voice}中心语给VP限定语的DP指派了一个受格。
