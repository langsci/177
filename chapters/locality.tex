...
可以跨越短语边界指派格的动词叫做ECM动词，ECM代表Exceptional Case Marking\isc{例外格标记（ECM）}\is{Exceptional Case Marking (ECM)}。正如名称所示，这种向短语中进行格指派被看作是一种例外。在这一理论的最新版本中（\egc \citealp[\page 120--123]{Kratzer96a}），所有格都可以指派到标志语位置。例如，下一页图~\vref{Abbildung-Kratzer}的Voice\isc{范畴!功能性的!Voice}\is{category!functional!Voice}中心语给VP标志语的DP指派了一个受格。
...
\zl
\textsc{xarg}特征的用法很像我们讨论的GB理论中可及标志语位置。但是波兰语\il{Polish}中介词的补语也可以借助\textsc{xarg}特征变得可及，因为有现象表明更高的中心语可以限制PP内部的成分\citep[\S~5.4.1.2]{Prze99b}。
