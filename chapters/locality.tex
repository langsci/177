...
\gll dass er$_i$ die Äpfel$_j$ ungewaschen$_{i/j}$ isst\\
	 \textsc{conj} 他 \textsc{det} 苹果 没洗的 吃\\
\glt `他吃没洗的苹果这件事'
%\gll dass er$_i$ die Äpfel$_j$ ungewaschen$_{i/j}$ isst\\
...
\gll dass er$_i$ ungewaschen$_{i/*j}$ die Äpfel$_j$ isst\\
	 \textsc{conj} 他 没洗的 \textsc{det} 苹果 吃\\
\glt `虽然他没被洗但是他吃苹果这件事'
%\gll dass er$_i$ ungewaschen$_{i/*j}$ die Äpfel$_j$ isst\\
...
%}
%\hfill\mbox{}
\caption{“dass er die Äpfel ungewaschen isst”（\textsc{conj} 他 \textsc{det} 苹果 没洗的 吃）和“dass er ungewaschen die Äpfel isst”（\textsc{conj} 他 没洗的 \textsc{det} 苹果 吃）的分析}\label{anal-er-die-frau-nackt-sieht}
