...
这种抽象的方式就叫做\xbarc 理论 （或者X"=杠理论）。该理论由\citet{Chomsky70a}提出，并由\citet{Jackendoff77}完善。这种形式的抽象规则在很多不同的理论中发挥了重要的作用。比如说：管辖与约束理论（第\ref{Kapitel-GB}章）、扩展的短语结构语法（第\ref{Kapitel-GPSG}章）和词汇功能语法（第\ref{Kapitel-LFG}章）。在中心语驱动的短语结构语法（第\ref{Kapitel-HPSG}章）中，\xbarc 理论也起到了重要的作用，但是并没有采纳\xbarc 范式的所有限制条件。
