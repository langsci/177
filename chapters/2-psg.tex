...
\gll eine Frau, die wir kennen\\
	 \textsc{art} 女人 \textsc{conj} 我们 认识\\
\ex 
\gll eine Frau aus Stuttgart\\
	 \textsc{art} 女人 \textsc{prep} 斯图加特\\
\ex 
\gll eine kluge Frau\\
	 \textsc{art} 聪明 女人\\
\ex 
\gll eine Frau aus Stuttgart, die wir kennen\\
	 \textsc{art} 女人 \textsc{prep} 斯图加特 \textsc{conj} 我们 认识\\
\ex 
\gll eine kluge Frau aus Stuttgart\\
	 \textsc{art} 聪明 女人 \textsc{prep} 斯图加特\\
\ex 
\gll eine kluge Frau, die wir kennen\\
	 \textsc{art} 聪明 女人 \textsc{conj} 我们 认识\\
\ex 
\gll eine kluge Frau aus Stuttgart, die wir kennen\\
	 \textsc{art} 聪明 女人 \textsc{prep} 斯图加特 \textsc{conj} 我们 认识\\
\zl
%\eal
%\label{Beispiele-NP-Adjunkte}
%\ex 
...
\gll B: Nein, ich kenne eine glückliche kluge Frau.\\
	\spacebr{} 不 我 认识 \textsc{art} 开心 聪明 女人\\
...
\gll dass Peter dem Mann das Buch \st{gibt} und Maria der Frau die Schallplatte gibt\\
	 \textsc{conj} Peter \textsc{det} 人 \textsc{det} 书 给 和 Maria \textsc{det} 女人 \textsc{det} 唱片 给\\
...
\gll eine kluge \_ aus Hamburg\\
	 \textsc{art} 聪明 {} \textsc{prep} 汉堡\\
\glt `一位从汉堡来的聪明的'
\ex 
\gll eine kluge \_, die alle kennen\\
	 \textsc{art} 聪明 {} \textsc{conj} 所有人 知道\\
\glt `一个大家都知道的聪明的'
\zl
...
\gll (Nein, nicht das Bild von der Stadtautobahn), das \_ vom Gleimtunnel war beeindruckend.\\
	 \spacebr{}不 不  \textsc{det} 图片 \textsc{prep} \textsc{det} 公路 \textsc{det} {} \textsc{prep}.\textsc{det} 格莱姆隧道 \textsc{aux} 印象深刻\\
...
\gll frisches Getreide, das gerade gemahlen wurde\\
	 新鲜 粮食 \textsc{conj} 刚刚 种 \textsc{aux}\\
\glt `刚种的新鲜的粮食'
...
\gll Dort drüben steht frisches, das gerade gemahlen wurde.\\
	 那儿 那边 有 新鲜 \textsc{conj} 刚 种 \textsc{aux}\\
\glt `在那边有一些刚种的新鲜的（粮食）。'
...
\gll {}[[Einen Schritt] vor dem Abgrund] blieb er stehen.\\
	 {}\spacebr{}\spacebr{}\textsc{art} 步 \textsc{prep} \textsc{det} 深渊 保留 他 站\\
\glt `他在离深渊一步之遥的地方站住了。'
\ex 
...
\gll {}[[Schräg] hinter der Scheune] ist ein Weiher.\\
	 {}\spacebr{}\spacebr{}斜 \textsc{prep} \textsc{det} 谷仓 \textsc{cop} \textsc{art} 池塘\\
\glt `在谷仓的斜对面有一个池塘。'
\ex 
\gll {}[[Mitten] im Urwald] stießen die Forscher auf einen alten Tempel.\\
	 {}\spacebr{}\spacebr{}中间 \textsc{prep}.\textsc{det} 丛林 碰到 \textsc{det} 研究人员 \textsc{prep} \textsc{art} 古老 寺庙\\
