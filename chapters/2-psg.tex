...
实际上，（\mex{0}）和（\ref{bsp-grammatik-psg}）中的文法都不够精确。如果我们在文法中加入额外的词条，如ich（我）和den（\textsc{art}.\textsc{def}的宾格形式），那么就会生成不合语法的句子，如例（\mex{1}b--d）所示：\footnote{%
...
\gll der Mann erwartet\\
     \textsc{art}.\textsc{def} 人 希望\\
}
\ex[*]{
\gll des        Mannes     er        das Buch dem Mann gibt\\
     \textsc{art}.\textsc{def}.\gen{} 人.\gen{} 他.\nom{} \textsc{art}.\textsc{def}.\acc{} 书 \textsc{art}.\textsc{def}.\dat{} 人 给\\
}
\zl
...
\gll er        das        Buch den        Mann gibt\\
     他.\nom{} \textsc{art}.\textsc{def}.\acc{} 书 \textsc{art}.\textsc{def}.\acc{} 人 给\\
}
\ex[*]{
\gll er        den        Buch       dem Mann gibt\\
     他.\nom{} \textsc{art}.\textsc{def}.\mas{} 书(\neu) \textsc{art}.\textsc{def} 人  给\\
}
\zl
...
\gll Er schläft das Buch.\\
	 他 睡觉 \textsc{art}.\textsc{def} 书\\
}
\ex[]{
\gll Er kennt das Buch.\\
	 他 知道 \textsc{art}.\textsc{def} 书\\
\mytrans{他知道这本书。}
}
\ex[*]{
\gll Er kennt.\\
...
\gll das Buch, die Bücher\\
	 \textsc{art}.\textsc{def} 书.\sg{} \textsc{art}.\textsc{def} 书.\pl\\\jambox{（数）}
\ex 
\gll des Buches, dem Buch\\
	 \textsc{art}.\textsc{def}.\gen{} 书.\gen{} \textsc{art}.\textsc{def}.\dat{} 书\\\jambox{（格）}
\ex\isce{屈折类型}{inflectional class} 
\gll ein Beamter, der Beamte\\
	 一 公务员 \textsc{art}.\textsc{def} 公务员\\\jambox{（屈折类型）}
\zl
...
[NP
  ...
  [\nbar
    [\nbar
      [N [Bild;照片] ]
      [PP [vom Gleimtunnel;……的.\textsc{art}.\textsc{def} 格莱姆隧道,roof ] ] ] 
    [PP [im Gropiusbau;在.\textsc{art}.\textsc{def} 格罗皮乌斯博物馆,roof ] ] ] ]
\end{forest}}
...
%rules out the sentences in (\mex{2}).
      ...
      \gll Er gibt ihr das Buch.\\
                 他.\nom{} 给 她.\dat{} \textsc{art}.\textsc{def} 书\\
      \mytrans{他给她这本书。}
...
%       }
      ...
      \gll  Er gibt ihr den Buch.\\
            他.\nom{} 给 她.\dat{} \textsc{art}.\textsc{def}.\mas{} 书.\neu{}\\
