...
{} {} \textsc{det} 骨架 \textsc{aux} {} 吞 \hspaceThis{(}\textsc{prep} \textsc{det} 男人\\
\glt `这个骨架被（这个男人）吞了。'
...
{} {} \textsc{det} 剑 \textsc{aux} {} 递 \textsc{prep} Tracy \hspaceThis{(}\textsc{prep} \textsc{det} 男人\\
...
\textsc{det} 狗窝 \textsc{conj} Mary 做 和 Fido 睡觉 \textsc{prep} \textsc{aux} \textsc{aux} 偷\\	 \jambox{(= S/NP \& S/NP)}
...
\textsc{det} 狗窝 \textsc{prep} \textsc{conj} Mary 放 药 和 Fido 睡觉 \textsc{aux} \textsc{aux} 偷\\\jambox{(= S/PP \& S/PP)}
...
\textsc{det} 狗窝 \hspaceThis{(}\textsc{prep} \textsc{conj} Mary 做 和 Fido 睡觉 \textsc{aux} \textsc{aux} 偷\\\jambox{(= S/NP \& S/PP)}
