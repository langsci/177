...
对于\isc{附加语|(}\is{adjunct|(}英语中的名词性结构， \citet[\page 126]{GKPS85a}认为\xbarc 分析以及我们在\ref{sec-psg-np}看到的分析适用于德语的名词结构。
...
V2  $\to$ W, AdvP
\z 
通过在（\ref{subjekt-meta}）中主语引入的元规则，（\ref{regel-ditransitiv-adv}）中的V3"=规则由V2"=规则推导出来。由于在一个句子中可以有几个附加语，必须允许可以多次应用像（\ref{Adjunkt-MR}）这样的元规则。
