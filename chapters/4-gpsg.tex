...
\end{tabular}
\z
这些规则可以用来分析（\mex{1}）中出现的动词短语dem Mann das Buch zu geben（给这个人这本书）和das Buch dem Mann zu geben（把这本书给这个人），但是不能分析（\ref{bsp-GPSG-anordnung}）这类句子，因为主语不在（\mex{0}）中规则的右边出现。
