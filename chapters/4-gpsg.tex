...
\textsc{det} 狗窝 \textsc{rel} Mary 做 和 Fido 睡觉 \textsc{prep} \textsc{aux} \textsc{aux} 偷\\	 \jambox{(= S/NP \& S/NP)}
...
\textsc{det} 狗窝 \textsc{prep} \textsc{rel} Mary 放 药 和 Fido 睡觉 \textsc{aux} \textsc{aux} 偷\\\jambox{(= S/PP \& S/PP)}
...
\textsc{det} 狗窝 \hspaceThis{(}\textsc{prep} \textsc{rel} Mary 做 和 Fido 睡觉 \textsc{aux} \textsc{aux} 偷\\\jambox{(= S/NP \& S/PP)}
