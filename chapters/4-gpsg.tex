...
德语被动式\isce[|(]{被动}{passive}可以按照如下的理论中立的方式来描写：\dotfootnote{%
...
接下来，我将详细讨论 \citew*{GKPS85a}中给出的被动分析。作者认为下面的元规则\isce[|(]{元规则}{metarule}适用于英语\ilce{英语}{English}（第59页）：\dotfootnote{%
...
\noindent
对此，必须使用（\mex{1}）中的元规则。该元规则从规则右边的范畴集合中去除了一个任意的范畴X，并在左边用斜杠（`/'）\isce{/}{/}来表示：\dotfootnote{%
