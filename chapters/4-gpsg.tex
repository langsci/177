...
\noindent
在简单的短语结构语法中，我们需要结合动词的配价类型，针对每对句子列出两条独立的规则，于是上面讨论的被动特征就不会在规则集合中被明确地表示出来。在GPSG中，可以应用元规则来解释主动和被动规则之间的关系：对于每条主动规则，相对应的带有受到抑制的主语的被动规则被允准了。主动句和被动句之间的联系可以通过这样的方式来描述。
