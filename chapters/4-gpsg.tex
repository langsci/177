...
但是，如果我们试着将这一分析应用到德语上，我们就会遇到问题。因为非人称被动\isc{被动!非人称被动|(}\is{passive!impersonal|(}不能简单地通过抑制宾语而得到。诸如arbeiten（工作）和denken（想）的动词的V2"=规则被用在（\ref{beispiel-arbeiten}a）和（\ref{beispiel-denken}a）的分析中：
