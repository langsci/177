...
\citet[\page 126]{GKPS85a}针对\isc{附加语|(}\is{adjunct|(}英语\ilce{英语}{English}中的名词性结构提出了\xbarc 分析，并且正如我们在\ref{sec-psg-np}中看到的，该分析适用于德语的名词结构。
...
接下来，我将详细讨论 \citew*{GKPS85a}中给出的被动分析。作者认为下面的元规则\isc{元规则|(}\is{metarule|(}适用于英语\ilce{英语}{English}（第59页）：\footnote{%
