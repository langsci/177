...
\gll Er verspricht, [dem Mann das Buch zu geben].\\
     他 承诺    \spacebr{}\textsc{det}.\dat{} 人 \textsc{det}.\acc{} 书 INF 给\\
\glt `他承诺给这个人这本书。'
...
\gll Er verspricht, [das Buch dem Mann zu geben].\\
	 他 承诺 \spacebr{}\textsc{det}.\acc{} 书 \textsc{det}.\dat{} 人 INF 给\\
\glt `他承诺把这本书给这个人。'
...
\gll Der Mann hat versucht, der Frau heimlich das Buch zu geben.\\
	\textsc{det} 男人 \textsc{aux} 尝试 \textsc{det} 女人 秘密地 \textsc{det} 书 INF 给\\
...
{} [\sub{S} \textsc{det} 男人 [\sub{VP} 吞 \textsc{det} 骨架]]\\
\glt `这个男人把骨架吞了。'
%{} [\sub{S} The man [\sub{VP} devoured the carcass]].
\ex
\gll {} [\sub{S} The man [\sub{VP} handed the sword to Tracy]].\\
{} [\sub{S} \textsc{det} 男人 [\sub{VP} 递 \textsc{det} 剑 \textsc{prep} Tracy]].\\
\glt `这个男人把剑递给Tracy。'
...
{} [\sub{S} \textsc{det} 骨架 \textsc{aux} [\sub{VP[\textsc{pas}]} 吞 (\textsc{prep} \textsc{det} 男人)]].\\
\glt `这个骨架被（这个男人）吞了。'
...
{} [\sub{S} \textsc{det} 剑 \textsc{aux} [\sub{VP[\textsc{pas}]} 递 \textsc{prep} Tracy (\textsc{prep} \textsc{det} 男人)]].\\
...
\gll {}[Um zwei Millionen Mark]$_i$ soll er versucht haben, [eine Versicherung \_$_i$ zu betrügen].\footnotemark\\
       {}\spacebr{}大约 两 百万 马克 应该 他 试图 \textsc{aux} \spacebr{}\textsc{art} 保险公司 {} INF 欺骗\\
...
\textsc{det} 狗窝 \textsc{conj} Mary 做 和 Fido 睡觉 \textsc{prep} \textsc{aux} \textsc{aux} 偷\\
...
\textsc{det} 狗窝 \textsc{prep} \textsc{conj} Mary 放 药 和 Fido 睡觉 \textsc{prep} \textsc{aux} \textsc{aux} 偷\\
...
\textsc{det} 狗窝 (\textsc{prep}) \textsc{conj} Mary 做 和 Fido 睡觉 \textsc{aux} \textsc{aux} 偷\\\
...
\gll {}[dass] ihn der Mann liest\\
	{}\spacebr{}\textsc{conj} 它.\acc{} \textsc{det}..\nom{} 男人 读\\
\glt `这个男人在读它'
