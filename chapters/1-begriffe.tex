...
\gll Er versucht, [das Buch zu lesen].\\
	他 试图 \spacebr{}DET 书 INF 读\\
\glt `他试着读这本书。'
\toaskstefan{Is 'zu' an INF or an AUX?}
\ex 
\gll Er versucht, [der Frau das Buch zu geben].\\
	 他 试图 \spacebr{}DET 女人 DET 书 INF 给\\
\glt `他试着把这本书给这位女士。'
\zl
%
...
\gll Er hat noch nicht [das Buch zu lesen] versucht.\\
     他 AUX \particle{} 不 \spacebr{}DET 书 INF 读 试图\\
\glt `他还没有试着读这本书。'
\ex 
\gll Er hat [das          Buch zu lesen] noch   nicht versucht.\\
     他 AUX \spacebr{}DET 书 INF 读  \particle{} 不 试图\\
\ex 
\gll Er hat noch nicht versucht, [das Buch zu lesen].\\
     他 AUX \particle{} 不 试图  \spacebr{}DET 书 INF 读\\
\zl
...
\gll Er hat versucht, [das Buch zu lesen] und [es dann unauffällig verschwinden zu lassen].\\
     他 AUX 试图 \spacebr{}DET 书 INF 读 和 \spacebr{}它 然后 悄悄地 消失 INF 让\\
...
\gll {}[Wenig] [mit Sprachgeschichte] hat der dritte Beitrag in dieser Rubrik zu tun, [\ldots]\footnotemark\\
       \spacebr{}少 \spacebr{} PREP 语言.历史 AUX DET 第三 文章 PREP DET 章节 INF 做\\
\footnotetext{
...
\gll Der dritte Beitrag in dieser Rubrik hat wenig mit Sprachgeschichte zu tun.\\
     DET 第三  文章 在 DET 章节  AUX 少 PREP 语言.历史 INF 做\\
\glt `这一节中的第三篇文章与语言历史没有太多的关系。'
\zl
...
如果副词和介词不能归入某个特定的类别，那么副词就通常被看作是一种没有屈折变化的“剩余”类，其他的介词，连词或者感叹词都不能归入副词。有时需要对这种“剩余”类进行进一步划分：只有那些用作一个成分出现在定式动词前的词可以被看作是副词。那些不能前置的词被称为“小品词”（particle）\isc{小品词}\is{particle}。这些小品词可以根据他们不同的功能而归入不同的类别，如程度助词和言外助词。由于这些基于功能的分类标准也包括了形容词，但是我不作这种区分，只是将之归为“副词”（adverb）。
...
\gll Studien haben gezeigt, daß mehr Unfälle in Städten passieren, \emph{wo} die Zebrastreifen abgebaut werden, weil die Autofahrer unaufmerksam werden.\footnotemark\\
     研究 AUX 表明 CONJ 更多 事故 PREP 城市 发生 哪里 DET 斑马线 去除 AUX 因为 DET 司机 疏忽 AUX\\
\footnotetext{
...
\gll Klaus behauptet, den Männern zu helfen.\\
	 Klaus 声称  DET.\dat{} 男人.\dat{} INF 帮助\\
\glt `Klaus声称要帮助那个男人。 '
}
\ex[]{
...
\gll Interessant, zu erwähnen, daß ihre Seele völlig    in Ordnung war.\footnotemark\\
	 有趣 INF 提到 CONJ 她的 灵魂 完整地 PREP 顺序 COP\\
\footnotetext{
...
\gll Interessant ist zu erwähnen, dass ihre Seele völlig in Ordnung war.\\
	 有趣 COP INF 提到 CONJ 她的 灵魂 完整地 PREP 顺序 COP\\
\glt `值得注意的是，她的灵魂完好无损。'
\ex %{\raggedright
...
\gll Über dieses Thema habe ich ihn gebeten, einen Vortrag zu halten.\\
      关于 DET 题目  AUX 我   他 请求    ART     演讲   INF hold\\
\glt `我请他做个有关这个题目的演讲。'
\ex 
\gll das Thema, über das ich ihn gebeten habe, einen Vortrag zu halten\\
     DET 题目  关于  我 他 请求  AUX ART 演讲 INF 作\\
\glt `这是那个我让他做一个演讲的题目'
\zl
...
\gll Kommt drauf an, mit wem dass sie zu tun haben.\\
     来 PREP \partic{} PREP 谁 CONJ 你 INF 做 AUX\\
\glt `这要取决于是谁在处理。'
%\ex
\zl
\eal
