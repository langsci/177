...
\glt `他试着读这本书。'
\toaskstefan{Is 'zu' an \textsc{inf} or an \textsc{aux}?}
\ex 
...
\gll Er hat noch nicht [das Buch zu lesen] versucht.\\
     他 \textsc{aux} \particle{} 不 \spacebr{}\textsc{det} 书 \textsc{inf} 读 试图\\
\glt `他还没有试着读这本书。'
\ex 
\gll Er hat [das          Buch zu lesen] noch   nicht versucht.\\
     他 \textsc{aux} \spacebr{}\textsc{det} 书 \textsc{inf} 读  \particle{} 不 试图\\
\ex 
\gll Er hat noch nicht versucht, [das Buch zu lesen].\\
     他 \textsc{aux} \particle{} 不 试图  \spacebr{}\textsc{det} 书 \textsc{inf} 读\\
\zl
...
\gll Die Männer behaupten, geholfen zu werden.\\
	 \textsc{det} 男人 声称 帮助 \textsc{inf} \textsc{aux}\\
\glt 想说：“那个男生声称得到了帮助。”
}
\ex[*]{
\gll Die Männer behaupten, elegant getanzt zu werden.\\
	 \textsc{det} 男人 声称 优雅地 跳舞 \textsc{inf} \textsc{aux}\\
\glt 想说：“那个男人声称在优雅地跳舞。”
}
\zl
...
\gll Interessant, zu erwähnen, daß ihre Seele völlig    in Ordnung war.\footnotemark\\
	 有趣 \textsc{inf} 提到 \textsc{conj} 她的 灵魂 完整地 \textsc{prep} 顺序 \textsc{cop}\\
\footnotetext{
...
\gll Interessant ist zu erwähnen, dass ihre Seele völlig in Ordnung war.\\
	 有趣 \textsc{cop} \textsc{inf} 提到 \textsc{conj} 她的 灵魂 完整地 \textsc{prep} 顺序 \textsc{cop}\\
\glt `值得注意的是，她的灵魂完好无损。'
\ex %{\raggedright
...
\gll Über dieses Thema habe ich ihn gebeten, einen Vortrag zu halten.\\
      关于 \textsc{det} 题目  \textsc{aux} 我   他 请求    \textsc{art}     演讲   \textsc{inf} hold\\
\glt `我请他做个有关这个题目的演讲。'
\ex 
\gll das Thema, über das ich ihn gebeten habe, einen Vortrag zu halten\\
     \textsc{det} 题目  关于  我 他 请求  \textsc{aux} \textsc{art} 演讲 \textsc{inf} 作\\
\glt `这是那个我让他做一个演讲的题目'
\zl
...
\gll Kommt drauf an, mit wem dass sie zu tun haben.\\
     来 \textsc{prep} \partic{} \textsc{prep} 谁 \textsc{conj} 你 \textsc{inf} 做 \textsc{aux}\\
\glt `这要取决于是谁在处理。'
%\ex
\zl
\eal
...
\gll Die Möglichkeit, etwas zu verändern, ist damit verschüttet für lange lange Zeit.\\
	 \textsc{det} 机会 东西 \textsc{inf} 变化 \textsc{cop} 在那儿 消失 \textsc{prep} 长 长 时间\\
\glt `变革的机会将要消失很长很长时间了。'	  
\ex 
\gll {}[Verschüttet für lange lange Zeit] ist damit die Möglichkeit,      etwas zu ver"-ändern.\\
      \spacebr{}消失 \textsc{prep} 长 长 时间 \textsc{cop} 在那儿 \textsc{det} 机会  东西 \textsc{inf} 变化\\
\ex 
