...
\gll This sentence goes on and on and on and on \ldots \\
       这 句子 长 \textsc{adv} 和 \textsc{adv} 和 \textsc{adv} 和 \textsc{adv} \ldots \\
...
如果我们不希望语言仅仅是由一个个形式意义对儿构成的列表，那么必然需要某种过程，该过程使得复杂话语的意义可以从更小的成分的意义推导而来。句法就是用来揭示词汇组合的方式和话语的结构的。比如说，主谓一致\isce{主谓一致}{agreement}的知识有助于我们解释下面的德语句子：
...
%\noindent
在下一节，我会介绍几种不同的测验方法来判断哪些词与其他词相比是“在一起的”。每当我说到一个“词语序列”\isce{词语序列}{word sequence}（word sequence）的时候，通常是指一个任意的线性词语序列，它并不必须具有句法或语义上的联系，比如说例（\mex{0}）中students read during（学生们读在）。而由一组词组成的结构单位通常叫做“短语”\isce{短语}{phrase}（phrase）。短语由词构成，如this time（这个时候），或者由词与短语组成，如during this time（在这个时候）。短语内的部分和短语本身叫做“组成成分”\isce{组成成分}{constituent}（constituents）。所以说，在图\ref{Abbildung-Schachteln}中，盒子中的所有成分都是句子的组成成分。
...
\gll Er hat noch nicht [das Buch zu lesen] versucht.\\
     他 \textsc{aux} 还 不 \spacebr{}\textsc{art}.\textsc{def} 书 \textsc{inf} 读 试图\\
\mytrans{他还没有试着读这本书。}
\ex 
\gll Er hat [das          Buch zu lesen] noch   nicht versucht.\\
     他 \textsc{aux} \spacebr{}\textsc{art}.\textsc{def} 书 \textsc{inf} 读  还 不 试图\\
\ex 
\gll Er hat noch nicht versucht, [das Buch zu lesen].\\
     他 \textsc{aux} 还 不 试图  \spacebr{}\textsc{art}.\textsc{def} 书 \textsc{inf} 读\\
\zl
...
\gll [Alle Studenten] lesen während der vorlesungsfreien Zeit Bücher.\\
      \spacebr{}所有 学生 读.\textsc{3pl} 在 \textsc{art}.\textsc{def} 课程.空闲 时间 书\\
\mytrans{所有的学生都在假期的时候看书。}
}
\ex[]{
\gll [Bücher] lesen alle Studenten während der vorlesungsfreien Zeit.\\
     \spacebr{}书 读 所有 学生 在 \textsc{art}.\textsc{def} 课程.空闲 时间\\
}
\ex[*]{
\gll [Alle Studenten] [Bücher] lesen während der vorlesungsfreien Zeit.\\
     \spacebr{}所有 学生 \spacebr{}书 读 在 \textsc{art}.\textsc{def} 课程.空闲 时间\\
}
\ex[*]{
\gll [Bücher] [alle Studenten] lesen während der vorlesungsfreien Zeit.\\
     \spacebr{}书 \spacebr{}所有 学生 读 在 \textsc{art}.\textsc{def} 课程.空闲 时间\\
}
\zl 
...
\gll Es und der Mann regnet / regnen.\\
     \textsc{expl} 和 \textsc{art}.\textsc{def} 男人 下雨.\textsc{3sg}   {} 下雨.\textsc{3pl} \\
}
\z
...
%können.%}
\begin{quotation}
\textbf{句子成分测试}\isce{组成成分}{constituent}是一个应用$\to$话题化的方式来对复杂成分进行分析的过程。由于话题化只允许一个单独的成分移到句子的开头，复杂的成分序列，比如说副词短语，实际上包括一个或多个组成成分。在Ein Taxi quält sich im Schrittempo durch den Verkehr（出租车正在以步行的速度费力地前进）这个例子中，im Schrittempo（以步行的速度）和durch den Verkehr（通过交通）都是句子成分，因为它们都可以各自独立地前置。\citep[\page446]{Bussmann83a}\footnote{%
...
\gll Sie einigen sich über die Agrarsubventionen.\\
     他们 同意 \refl{} 关于 \textsc{art}.\textsc{def} 农业.补贴\\
...
\gll Man ist / bleibt trocken durch die Stadt.\\
     人 \textsc{aux} {} 保持 干的 通过 \textsc{art}.\textsc{def} 城市\\
}
\zl
...
\gll Er bringt es bis zum Professor.\\
     他 拿 \expl{} 直到 向.\textsc{art}.\textsc{def} 教授\\
\mytrans{他把它拿给教授。}
}
\ex[\#]{
\gll Es bringt er bis zum Professor.\\
     \expl{} 拿 他 直到  向.\textsc{art}.\textsc{def} 教授\\
} 
\zl
...
定式动词前的位置也叫作“前场”（Vorfeld）\isce{前场}{Vorfeld}（参见\ref{Abschnitt-Toplogie}）。德语中，显性多重前置\iscesub{前置}{fronting}{显性多重前置}{apparent multiple}在某些情况下是可能的。请参考前面的内容，尤其是第\pageref{bsp-mehr-vf}页的例（\ref{bsp-mehr-vf}）。例（\mex{1}）也是一个例子，对于kaufen（买）这类动词来说，主语在前场的位置上是比较少见的，因为这种前置的结构与信息结构有关。我们也可以比较\citet{dKM2003a} 有关前置动词短语中主语的研究，以及\citet[\page 72]{BC2010a}有关显性多重前置的主语前置方面的研究。
}
...
\gll Der Mann einen Esel kaufte deshalb.\\
     \textsc{art}.\textsc{def} 男人  一     驴子 买 所以\\
}
\z
...
\mytrans{下雨了。}
\zl
我们也可以将Erörterung（讨论）归入动作类动词。\isce[|)]{动词}{verb}形容词\isce[|(]{形容词}{adjective}并不总是描述事物的属性。在下面的例子中，相反的情况是真实存在的，即将一个杀人犯的特质表示为一种可能或者猜测，而不是被修饰名词的真实属性。
...
\gll Sie lachen.\\
     他们 笑\\
\zl
德语也有过去式、命令式、虚拟语气和不定式（分词和带zu与不带zu的不定式）的形态变化。这些形式就构成了动词的屈折词形变化表\iscesub{词形变化表}{paradigm}{屈折}{inflection}。时态\isce{时态}{tense} （现在式\isce{现在式}{present}、过去式\isce{过去式}{preterite}、将来式\isce{将来式}{future}）、情态\isce{情态}{mood} （陈述语气\isce{陈述语气}{indicative}、虚拟语气\isce{虚拟语气}{subjunctive}、命令语气\isce{命令语气}{imperative}）、人称\isce{人称}{person}（第1，2，3人称）和数\isce{数}{number}（单数\isce{单数}{singular}、复数\isce{复数}{plural}）都在屈折的词形变化表中有所体现。在有些词形变化中这些形式有所重合，如例（\mex{0}c）、例（\mex{0}e）、例 （\mex{0}d）和例 （\mex{0}f）所示。
...
到目前为止，我们所讨论的词类与屈折变化属性的概念是不同的。对于那些没有屈折变化的词而言，我们需要用到额外的标准。比如说，我们可以通过它们出现的句法环境来判别词类（正如我们对上面有屈折变化的形容词所做的那样）。我们可以区分出介词\isce{介词}{preposition}、副词\isce{副词}{adverbs}、连词\isce{连词}{conjunction}、感叹词\isce{感叹词}{interjection}，有时也可以区分出小品词\isce{小品词}{particle}。介词是指那些与名词共现，并决定这些名词的格属性的一类词：
...
\isce{add chinese term}{postposition}\fixme
\ea
\gll des Geldes wegen\\
	 \textsc{art}.\textsc{def} 钱.\gen{} 因为\\
\mytrans{因为钱}
\z
如果想要对词的位置保有中立态度的话，那么你也可以将之称为“附置词”（adpositions）\isce{附置词}{adposition}。
...
我们也可以认为这里是词类发生了变化。如果一个词的词类发生了变化，但是并没有加上可见的词缀，那么，我们可以把这类现象叫做“零形派生”（conversion）\isce{零形派生}{conversion}。有些语言学家认为零形派生是词汇派生\isce{词类派生}{derivation}的一个次级类型。
...
\gll Des Mannes liest einen Aufsatz.\\
	 \textsc{art}.\textsc{def} 男人.\gen{} 读 一 文章\\
} 
\zl 
...
语义角色包括施事\isce{施事}{agent}（发出动作的人）、受事\isce{受事}{patient}（受到影响的人或物）、受益者（得到东西或经验的人）和经事\isce{经事}{experiencer}（经历某种心理状态的人）。help（帮助）的主语是施事，直接宾语是受益者。充当语义角色的论元也叫做“行动元”（actant\isce{行动元}{actant}）。这个术语用来指称无生命的物体。
...
\gll The man the boy sleeps.\\
      \textsc{art}.\textsc{def} 男人 \textsc{art}.\textsc{def}  男孩 睡觉\\
}
\z
...
\gll Er gedenkt des Opfers.\\
	 他 想起 \textsc{art}.\textsc{def}.\gen{} 受害人.\gen{}\\
\mytrans{他想起受害人。}
}
\ex[*]{
\gll Er gedenkt dem Opfer.\\
	 他 想起 \textsc{art}.\textsc{def}.\dat{} 受害人\\
}
\ex[]{
\gll Er hilft dem Opfer.\\
	 他 帮助 \textsc{art}.\textsc{def}.\dat{} 受害人\\
\mytrans{他帮助受害人。}
}
\ex[*]{
\gll Er hilft des Opfers.\\
	 他 帮助 \textsc{art}.\textsc{def}.\gen{} 受害人.\gen{}\\
}
\zl
...
\begin{itemize}
\item 与变位动词构成主谓一致\isce{主谓一致}{agreement}的关系
...
%\end{itemize}
我已经在例（\ref{Beispiel-mit-Kongruenz}）中讨论过主谓一致的问题。 \citet{Reis82}认为第二个要点适用于德语。她构建了非名词性从句的限制条件，因为名词作谓语的句子可以有不止一个名词性的论元成分，如例（\mex{1}）所示：
...
\noindent
有趣的是，冰岛语\ilce{冰岛语}{Icelandic}中的与格论元表现不同。 \citet{ZMT85a}讨论了冰岛语中主语的各种特征，并且认为可以把被动句中的与格论元视为主语，即使变位动词与它们没有构成主谓一致的关系（3.1），以及它们并不带有主格。例如，下面就是带有被省略的与格论元的不定式结构（第457页）：
...
最近发表的文献表明，词汇功能语法中还有一些相关的讨论（参考第\ref{Kapitel-LFG}章）\citep*{DL2000a-u,Berman2003b-u,Berman2007a-u,AMM2005a-u,Forst2006a-u}。\isce[|)]{主语}{subject}  
...
\gll weil den ganzen Tag gearbeitet wurde\\
	 因为 \textsc{art}.\textsc{def}.\acc{} 整.\acc{} 天 工作 \passivepst\\
\mytrans{因为有人整天工作}
}
\ex[*]{
\gll weil der ganze Tag gearbeitet wurde\\
	 因为 \textsc{art}.\textsc{def}.\nom{} 整.\nom{} 天 工作 \passivepst\\
}
\zl
\isce[|)]{状语}{adverbial}
...
\zl
        ...
        \gll Er lässt den lieben Gott `n frommen Mann sein.\\
	     他 让 \textsc{art}.\textsc{def}.\acc{} 亲爱的.\acc{} 上帝 一 虔诚的.\acc{} 人 \textsc{aux}\\
        \mytrans{他过着无忧无虑的生活。}
        }
        \ex[*]{
        \gll Er lässt den lieben Gott `n frommer Mann sein.\\
	     他 让 \textsc{art}.\textsc{def}.\acc{} 亲爱的.\acc{} 上帝 一 虔诚的.\nom{} 人 \textsc{aux}\\
        }
        \zllast}
...
\mytrans{他被人叫做骗子。}
\zl
例（\mex{0}a）中，只有ihn（他）被描述成宾语。在例（\mex{0}b）中，ihn（他）变成了主语，也就成为了主格。在例（\mex{0}a）中，einen Lügner（一个骗子）指代ihn（他），例（\mex{0}b）中的er（他）需要与作谓语的名词的格保持一致。这也叫做“格的一致关系”（agreement case）\iscesub{格}{case}{一致关系}{agreement}。
...
\gll (Peter hat erzählt,) dass er das Eis gegessen \emph{hat}.\\
     \hspaceThis{(}Peter  \textsc{aux} 告诉 \textsc{comp} 他 \textsc{art}.\textsc{def} 雪糕 吃 \textsc{aux}\\
...
基于这个原因，我们称之为“框架结构”\isce{框架结构}{sentence bracket}（sentence bracket）。
...
%\newpage
\iscesee{前场}{场check}{prefield}{field}%
\iscesub{场}{field}{前-}{pre-}%
\iscesee{中场}{场check}{middle field}{field}%
\iscesub{场}{field}{中-}{middle-}%
\iscesee{后场}{场check}{postfield}{field}%
...
%
\begin{tabular}{@{}l@{}}Karl\\Karl\end{tabular}    & \begin{tabular}{@{}l@{}}färbt\\染色\end{tabular}         & \begin{tabular}{@{}l@{~}l@{}}den & Mantel\\\textsc{art}.\textsc{def} & 大衣\end{tabular}  & \begin{tabular}{@{}l@{}}um\\\particle\end{tabular}       & \begin{tabular}{@{}l@{~}l@{~}l@{}}den & Maria & kennt.\\\textsc{rel} & Maria & 认识\end{tabular}           \\
%Karl    & 染色           & \textsc{art}.\textsc{def} 大衣                 & \particle                 & \textsc{rel} Maria 认识\\%\tablevspace
%
Karl      & hat             & Maria                                  & {erkannt.} \\
Karl      & \textsc{aux}    & Maria                                  & 认出\\%\tablevspace
%
\begin{tabular}{@{}l@{}}Karl\\Karl\end{tabular}    & \begin{tabular}{@{}l@{}}hat\\\textsc{aux}\end{tabular} & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l@{}}Maria & als & sie & aus & dem & Bus & stieg & sofort\\Maria & 当 & 她 & 从 & \textsc{art}.\textsc{def} & 巴士 & 下车 & 立即\end{tabular} & \begin{tabular}{@{}l@{}}erkannt.\\认出\end{tabular} \\
%	Karl      & \textsc{aux}           & Maria 当 她 从 \textsc{art}.\textsc{def} 巴士 下车 立即 & 认出\\%\tablevspace
%
\begin{tabular}{@{}l@{}}Karl\\Karl\end{tabular}    & \begin{tabular}{@{}l@{}}hat\\\textsc{aux}\end{tabular} & \begin{tabular}{@{}l@{~}l@{}}Maria & sofort\\Maria & 立即\end{tabular} & \begin{tabular}{@{}l@{}}erkannt\\认出\end{tabular}     & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{~}l@{}}als & sie & aus & dem & Bus & stieg.\\当 & 她 & 从 & \textsc{art}.\textsc{def} & 巴士 & 下车\end{tabular} \\
%	Karl      & \textsc{aux}           & Maria 立即                      & 认出     & 当 她 从 \textsc{art}.\textsc{def} 巴士 下车\\%\tablevspace
%
...
%
        & \begin{tabular}{@{}l@{}}hat\\\textsc{aux}\end{tabular}   & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l@{}}er & doch & den & ganzen & Kuchen & alleine\\他 & 还 & \textsc{art}.\textsc{def} & 整个 & 蛋糕 & 单独\end{tabular}           & \begin{tabular}{@{}l@{}}gegessen!\\吃\\\end{tabular}\\
%       & \textsc{aux}           & 他 \ \ 还 \ \ \ \textsc{art}.\textsc{def} \ \ 整个 \ \ \ \ 蛋糕 \ \ \ \ 单独 & 吃\\%\tablevspace
% \end{tabular}
% %}
% %\end{sideways}
...
% Prefield & Left bracket & Middle field                           & Right bracket & Postfield                   \\\lsptoprule
        & \begin{tabular}{@{}l@{}}weil\\因为\end{tabular}   & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{}}er & den & ganzen & Kuchen & alleine\\他 & \textsc{art}.\textsc{def} & 整个 & 蛋糕 & 单独\end{tabular} & \begin{tabular}{@{}l@{~}l@{}}gegessen & hat\\吃 & \textsc{aux}\end{tabular}   & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{}}ohne & es & zu & bereuen\\没有 & 它 & \textsc{inf} & 后悔\end{tabular}  \\
%        & 因为       & 他 \ \textsc{art}.\textsc{def} \ \ 整个 \ \ \ 蛋糕 \ \ \ 单独           & 吃 \ \ \ \ \  \ \ \ \ \ \textsc{aux} & 没有 \ 它 \ \textsc{inf} \ 后悔\\%\tablevspace

       & \begin{tabular}{@{}l@{}}weil\\因为\end{tabular}    & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{}}er & den & ganzen & Kuchen & alleine\\他 & \textsc{art}.\textsc{def} & 整个 & 蛋糕 & 单独\end{tabular} & \begin{tabular}{@{}l@{~}l@{~}l@{}}essen & können & will\\吃 &  能 & 想 \end{tabular}   & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{}}ohne & gestört & zu & werden\\没有 &  打扰 & \textsc{inf} & \passive{}\end{tabular}    \\
%        & 因为       & 他 \textsc{art}.\textsc{def} \ \ 整个 \ \ \ 蛋糕 \ \ \  单独            & 吃 \ \ \ \ \ \ \  能 \ \ \ \ \ \ \ 想    & 没有 \  打扰 \ \ \ \textsc{inf} \passive{}\\%\tablevspace
%
\begin{tabular}{@{}l@{}}wer\\谁\end{tabular}     &               & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{~}l@{}}er & den & ganzen & Kuchen & alleine\\他 & \textsc{art}.\textsc{def} & 整个 & 蛋糕 & 单独\end{tabular}                  & \begin{tabular}{@{}l@{~}l@{}}gegessen & hat\\吃 & \textsc{aux}\end{tabular} \\
%	谁     &               & \textsc{art}.\textsc{def} \ \ 整个 \ \ \ 蛋糕 \ \ \ 单独              & 吃 \ \ \ \  \ \ \ \ \ \ \textsc{aux}\\%\tablevspace
%
\begin{tabular}{@{}l@{}}der\\\textsc{rel}\end{tabular}     &               & \begin{tabular}{@{}l@{~}l@{~}l@{~}l@{}} den & ganzen & Kuchen & alleine\\\textsc{art}.\textsc{def} & 整个 & 蛋糕 & 单独\end{tabular}                 &\begin{tabular}{@{}l@{~}l@{}}gegessen & hat\\吃 & \textsc{aux}\end{tabular}  \\
%\textsc{rel}     &               & \textsc{art}.\textsc{def} \ \ 整个 \ \ \ 蛋糕 \ \ \ 单独              & 吃 \ \ \ \ \ \ \ \ \ \ \textsc{aux}\\%\tablevspace
%
...
\gll Er hat [der Frau] das Buch gegeben, [die er kennt].\\
     他 \textsc{aux} \spacebr{}\textsc{art}.\textsc{def} 女人 \textsc{art}.\textsc{def} 书 给 \spacebr{}\textsc{rel} 他 认识\\
\mytrans{他把书交给他认识的那个女人。}
}
\ex[*]{
\gll Er hat [der Frau] das Buch, [die er kennt,] gegeben.\\
     他 \textsc{aux} \spacebr{}\textsc{art}.\textsc{def} 女人 \textsc{art}.\textsc{def} 书 \spacebr{}\textsc{rel} 他 认识 给\\
}
\ex[]{
\gll Er hat [der Frau, die er kennt,] das Buch gegeben.\\
     他 \textsc{aux} \spacebr{}\textsc{art}.\textsc{def} 女人 \textsc{rel} 他 认识 \textsc{art}.\textsc{def} 书 给\\
}
\zl
...
\item 请指出例（\mex{1}）所示的整句及其小句中的中心语、论元和附加语：
  \ea
	\gll Er hilft den kleinen Kindern in der Schule.\\
		 他 帮助 \textsc{art}.\textsc{def} 小 孩子 在 \textsc{art}.\textsc{def} 学校\\
	\mytrans{他在学校帮助小孩子。}
  \z
...
\gll Der Mann liebt eine Frau, den Peter kennt.\\
     \textsc{art}.\textsc{def} 男人  爱   一 女人 \textsc{rel} Peter 认识\\
...
\gll Die Studenten haben behauptet, nur wegen der Hitze einzuschlafen.\\
	 \textsc{art}.\textsc{def} 学生们 \textsc{aux} 声称 只 因为 \textsc{art}.\textsc{def} 热 睡着了\\
...
\gll Der Mittwoch, der passt mir gut.\\
	 \textsc{art}.\textsc{def} 星期三 \textsc{dem} 适合 我 好\\
\mytrans{周三，我有空。}
\z
\eal
\ex 
\gll Aber würde denn jemand den Hund füttern morgen Abend?\\
     但是 将 究竟 有人 \textsc{art}.\textsc{def} 狗 喂 明天 晚上\\
