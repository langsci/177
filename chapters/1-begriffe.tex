...
需要说明的是，语言学领域里术语纷杂，难以统一。造成这一现象的部分原因是，这些术语最早来源于对某些语言（\egc 拉丁语\il{Latin}、英语\il{English}）的分析，而后又被用于描述其他语言现象。然而，这样做并不合适，因为有些语言与其他语言区别很大，加之语言本身也在不断地发展变化。基于以上原因，有些术语的用法发生了变化或者是创造出了新的术语。
...
\gll  {}[A sentence is a sentence] is a sentence. \\
      {}\textsc{art} 句子 \textsc{cop} \textsc{art} 句子 \textsc{cop} \textsc{art} 句子\\
...
\gll that Max thinks that Julius knows that Otto claims that Karl suspects that Richard confirms that Friederike is laughing\\
      \textsc{conj} Max 认为 \textsc{conj} Julius 知道 \textsc{conj} Otto 声称 \textsc{conj} Carl 怀疑 \textsc{conj} Richard 承认 \textsc{conj} Friederike \textsc{aux} 笑\\
\zl
...
\gll Er versucht, [das Buch zu lesen].\\
	他 试图 \spacebr{}\textsc{det} 书 INF 读\\
\glt `他试着读这本书。'
\toaskstefan{Is 'zu' an INF or an \textsc{aux}?}
\ex 
\gll Er versucht, [der Frau das Buch zu geben].\\
	 他 试图 \spacebr{}\textsc{det} 女人 \textsc{det} 书 INF 给\\
\glt `他试着把这本书给这位女士。'
\zl
%
...
\gll Peter versucht, [das Buch zu lesen].\\
	 Peter 试图 \spacebr{}\textsc{det} 书 INF 读\\
\glt `Peter试着读这本书。'
\ex 
...
\gll dass keiner [diese Frau] kennt\\
     \textsc{conj} 没有 \textsc{det} 女人 认识\\
  }
\ex[]{
\gll dass [diese Frau] keiner kennt\\
	 \textsc{conj} \textsc{det} 女人 没有 认识\\
\glt `没有人认识这个女人'
  }
\zl
...
\gll  dass Frau keiner diese kennt\\
      \textsc{conj} 女人 没有 \textsc{det} 认识\\
}
\ex[*]{
\gll dass Frau kennt keiner diese\\
     \textsc{conj} 女人 认识 没有 这\\
}
\zl
...
\gll Er hat noch nicht [das Buch zu lesen] versucht.\\
     他 \textsc{aux} \particle{} 不 \spacebr{}\textsc{det} 书 INF 读 试图\\
\glt `他还没有试着读这本书。'
\ex 
\gll Er hat [das          Buch zu lesen] noch   nicht versucht.\\
     他 \textsc{aux} \spacebr{}\textsc{det} 书 INF 读  \particle{} 不 试图\\
\ex 
\gll Er hat noch nicht versucht, [das Buch zu lesen].\\
     他 \textsc{aux} \particle{} 不 试图  \spacebr{}\textsc{det} 书 INF 读\\
\zl
...
\gll Er hat versucht, [das Buch zu lesen] und [es dann unauffällig verschwinden zu lassen].\\
     他 \textsc{aux} 试图 \spacebr{}\textsc{det} 书 INF 读 和 \spacebr{}它 然后 悄悄地 消失 INF 让\\
...
\gll Er sah einen Mann klatschen.\\
	 他 看见 \textsc{art}.\acc{} 男人 鼓掌\\
\glt `他看见一个男人在鼓掌。'
}
\ex[]{
\gll Einen Mann sah er klatschen.\\
	 \textsc{art}.\acc{} 人 看见 他 鼓掌\\
\glt `一个男人，他看见在鼓掌。'
}
\zl
...
\gll Es und der Mann regnet / regnen.\\
     它 和 \textsc{det} 男人 下雨.\textsc{3sg}   {} 下雨.\textsc{3pl} \\
}
\z
...
%können.%}
\begin{quote}
\textbf{句子成分测试}\isc{组成成分}\is{constituent}是一个应用$\to$话题化的方式来对复杂成分进行分析的过程。由于话题化只允许一个单独的成分移到句子的开头，复杂的成分序列，比如说副词短语，实际上包括一个或多个组成成分。在“Ein Taxi quält sich im Schrittempo durch den Verkehr（出租车正在以步行的速度顽强地前进）”这个例子中，im Schrittempo（以步行的速度）和durch den Verkehr（通过交通）都是句子成分，因为他们都可以各自独立地前置。\citep[\page446]{Bussmann83a}
...
\begin{itemize}
\item 如果某一个语言片段中的某一部分断片可以各自独立地前置$\to$\\
	那么该语言片段不构成一个成分。
...
\gll Keine Einigung erreichten Schröder und Chirac über den Abbau der      Agrarsubventionen.\footnotemark\\
     不    一致      达成        Schröder 和  Chirac 关于  \textsc{det} 减少  \textsc{prep}.\textsc{det} 农业.补贴\\
\footnotetext{《每日新闻》, \zhdate{2002/10/15}，晚八点。}
%tagesschau, 15.10.2002, 20:00.
\glt `Schröder和Chirac不能就农业补贴的减少达成一致。 '
\ex 
\gll [Über           den Abbau     der    Agrarsubventionen]     erreichten Schröder und Chirac keine Einigung.\\
     \spacebr{}关于 \textsc{det} 减少 \textsc{det} 农业.补贴 达成 Schröder 和 Chirac 不 一致\\
\zl
...
\gll Schröder und Chirac erreichten [keine Einigung über den Abbau der~~~~~~~~~~~~~~ Agrarsubventionen].\\
     Schröder 和 Chirac 达成 \spacebr{}不 一致 关于 \textsc{det} 减少 \textsc{det} 农业.补贴\\
\z
...
\gll {}[Keine Einigung über den Abbau der Agrarsubventionen] erreichten Schröder und Chirac.\\
     \spacebr{}不 一致 关于 \textsc{det} 减少 \textsc{det} 农业.补贴  达成 Schröder 和 Chirac\\
\z
...
\gll {}[Trocken] [durch die Stadt] kommt man am Wochenende auch mit der BVG.\footnotemark\\
	 \spacebr{}变干的 \spacebr{}通过 \textsc{det} 城市 来 人 \textsc{prep}.\textsc{det} 周末 也 \textsc{prep} \textsc{det} BVG\\
\footnotetext{
...
\gll {}[Wenig]     [mit Sprachgeschichte] hat der dritte Beitrag in dieser Rubrik zu tun, [\ldots]\footnotemark\\
       \spacebr{}少 \spacebr{}\textsc{prep} 语言.历史 \textsc{aux} \textsc{det} 第三 文章 \textsc{prep} \textsc{det} 章节 INF 做\\
\footnotetext{
...
\gll Der dritte Beitrag in dieser Rubrik hat wenig mit Sprachgeschichte zu tun.\\
     \textsc{det} 第三  文章 在 \textsc{det} 章节  \textsc{aux} 少 \textsc{prep} 语言.历史 INF 做\\
\glt `这一节中的第三篇文章与语言历史没有太多的关系。'
\zl
...
\gll Es bringt er bis zum Professor.\\
     它 拿 他 直到  \textsc{prep}.\textsc{det} 教授\\
} 
\zl
...
\gll Deshalb kaufte der Mann einen Esel und die Frau ein Pferd.\\
	 所以 买 \textsc{det} 男人 \textsc{art} 驴子 和 \textsc{det} 女人 \textsc{art} 马\\
...
\gll Der Mann einen Esel kaufte deshalb.\\
     \textsc{det} 男人  \textsc{art}     驴子 买 所以\\
}
\z
...
\gll Deshalb kaufte der Mann einen Esel und kaufte die Frau ein Pferd.\\
	所以 买 \textsc{det} 男人 \textsc{art} 驴子 和 买 \textsc{det} 女人 \textsc{art} 马\\
\z
...
\gll Ich komme eben aus der Stadt, \emph{wo} ich Zeuge eines Unglücks gewesen bin.\footnotemark\\
	 我 来 \particle{} 自 \textsc{det} 城市 \textsc{conj} 我 见证 PERP.\textsc{art} 事故 \textsc{aux} \textsc{cop} \\
\footnotetext{
...
\gll Studien haben gezeigt, daß mehr Unfälle in Städten passieren, \emph{wo} die Zebrastreifen abgebaut werden, weil die Autofahrer unaufmerksam werden.\footnotemark\\
     研究 \textsc{aux} 表明 \textsc{conj} 更多 事故 \textsc{prep} 城市 发生 哪里 \textsc{det} 斑马线 去除 \textsc{aux} 因为 \textsc{det} 司机 疏忽 \textsc{aux}\\
\footnotetext{
...
\gll Zufällig war ich in dem Augenblick zugegen, \emph{wo} der Steppenwolf zum erstenmal unser Haus betrat und bei meiner Tante sich einmietete.\footnotemark\\
	 恰巧地 \textsc{aux} 我 在 \textsc{det} 时候 出现 \textsc{conj} \textsc{det} 荒原狼 \textsc{prep}.\textsc{det} 第一次 我们的 房子 进入 和 在 我的 姑姑 \textsc{refl} 租房\\
...
\gll der Mann, dessen Schwester ich kenne\\
	 \textsc{det} 男人 \textsc{conj} 姐妹 我 认识\\
\ex 
\gll Ich möchte wissen, wessen Schwester du kennst.\\
	 我 想 知道 \textsc{conj} 姐妹 你 认识\\
\glt `我想知道你认识谁的姐妹。'
\zl
...
\gll Auf dem Europa-Parteitag fordern die \emph{Grünen} einen ökosozialen Politikwechsel.\\
	 在 \textsc{det} 欧洲-党会 要求 \textsc{det} 绿党 \textsc{art} 生态-社会 政治变革\\
...
\gll Ein Grüner hat vorgeschlagen, \ldots\\
	 \textsc{art} 绿党成员.\mas{} \textsc{aux} 提出建议\\
\glt `绿党的一位（男性）成员提出了建议 \ldots'
\ex 
\gll Eine Grüne hat vorgeschlagen, \ldots\\
	 \textsc{art} 绿党成员.\fem{} \textsc{aux} 提出建议\\
...
\gll Peter schläft im Büro.\\
     Peter 睡觉 PERP.\textsc{det} 办公室\\
\glt `Peter在办公室里睡觉。'
\ex 
\gll der Tisch im Büro\\
     \textsc{det} 桌子 PERP.\textsc{det} 办公室\\
\glt `办公室里的桌子'
\zl
...
\gll Die Männer liest einen Aufsatz.\\
	  \textsc{det} 男人 读 \textsc{art} 论文\\
} 
\ex[*]{ 
\gll Des Mannes liest einen Aufsatz.\\
	 \textsc{det} 男人.\gen{} 读 \textsc{art} 论文\\
} 
\zl 
...
\gll the man {\em who\/} {\em Mary\/} {\em loves\/}\\
      \textsc{det}  男人 \textsc{conj} Mary  爱\\
\glt `Mary爱着的那个男人'       
\zl
...
\gll The man and the boy are sleeping.\\
      \textsc{det} 男人 和 \textsc{det} 男孩  \textsc{cop} 睡觉\\
\glt `这个男人和这个男孩在睡觉。' 
\z
...
\gll Er schläft in der Schule / auf dem Weihnachtsmarkt / unter der Brücke.\\
	 他 睡觉 在 \textsc{det}.\dat{} 学校 {} 在 \textsc{det}.\dat{} 圣诞市场 {} 在......下 \textsc{det}.\dat{} 桥\\
\glt `他在学校／圣诞市场／桥下面睡觉。'
\zl
...
\gll Wir befinden uns hier / unter der Brücke / neben dem Eingang / im Bett.\\
	 我们 处于 \textsc{refl} 这儿 {} 在......下 \textsc{det} 桥 {} 在.....附近 \textsc{det} 入口 {} 在 床\\
\glt `我们在这儿／桥下面／入口旁／床上。'
\z
地点修饰词如hier（这儿）或unter der Brücke（桥下面）都可以看作是其他动词（\egc schlafen（睡觉））的附接语。对于sich befinden（位于）这类动词来说，我们更倾向于认为关于地点的信息构成了一个动词的必有句法论元。
...
\gll Den Männern wurde geholfen.\\
	 \textsc{det}.\dat{} 男人.\dat{} \textsc{aux}.3SG 帮助\\
\glt `那个男人被人帮助了。'
\zl
...
\gll Klaus behauptet, den Männern zu helfen.\\
	 Klaus 声称  \textsc{det}.\dat{} 男人.\dat{} INF 帮助\\
\glt `Klaus声称要帮助那个男人。 '
}
\ex[]{
\gll Klaus behauptet, dass er den Männern hilft.\\
	 Klaus 声称 \textsc{conj} 他 \textsc{det}.\dat{} 男人.\dat{} 帮助\\
\glt `Klaus声称他在帮助那个男人。'
}
\ex[*]{
\gll Die Männer behaupten, geholfen zu werden.\\
	 \textsc{det} 男人 声称 帮助 INF \textsc{aux}\\
\glt 想说：“那个男生声称得到了帮助。”
}
\ex[*]{
\gll Die Männer behaupten, elegant getanzt zu werden.\\
	 \textsc{det} 男人 声称 优雅地 跳舞 INF \textsc{aux}\\
\glt 想说：“那个男人声称在优雅地跳舞。”
}
\zl
...
\gll Die Männer behaupten, dass ihnen geholfen wird.\\
	 \textsc{det} 男人.\nom{} 声称 \textsc{conj} 他们.\dat{} 帮助 \textsc{cop}\\
\glt `这些男人们声称他们被帮助了。'
\z
%
...
\gll Ég vonast til að verða hjálpað.\\
     我 希望 PERP \textsc{aux} \textsc{cop} 帮助\\
\glt `我希望我能得到帮助。'
\ex
\gll Að vera hjálpað í prófinu er óleyfilegt.\\
     \textsc{aux} \textsc{cop} 帮助 PERP 考试 \textsc{cop} 不允许\\
\glt `在考试中是不允许被帮助的。'
\zl
...
\gll Dass er schon um sieben kommen wollte, stimmt nicht.\\
	 \textsc{conj} 他 已经 在 七点 来 想 确定 不\\
\glt `他想尽可能在七点赶来，这不是真的。'
\ex 
\gll Dass er Maria geheiratet hat, gefällt mir.\\
	 \textsc{conj} 他 Maria 娶 \textsc{aux} 高兴 我\\
\glt `我很高兴他娶了Maria。'
\zl
\eal
\ex
...
\gll dass er den Mann des Mordes bezichtigte\\
	 \textsc{conj} 他 \textsc{det}.\acc{} 人.\acc{} \textsc{det}.\gen{} 谋杀.\gen{} 控告\\
\glt `他控告了杀人的人'
\ex 
\gll dass er den Mann den Vers lehrte\\
	 \textsc{conj} he \textsc{det}.\acc{} 人.\acc{} \textsc{det}.\acc{} 诗.\acc{} 教\\
\glt `他教那个人读诗了'
\zl
这类宾语有时也叫做间接宾语。
...
\gll dass er dem Mann hilft\\
     \textsc{conj} 他 \textsc{det}.\dat{} 人.\dat{} 帮助\\
\glt `他帮助那个人'
\z
...
\gll Dass du sprichst, wird erwähnt.\\
     \textsc{conj} 你 说话 \textsc{cop} 提到\\
\glt `你在说话的事实被提及了。'
\ex
\gll Er erwähnt, dass du sprichst.\\
	 他 提到 \textsc{conj} 你 说话\\
\glt `他提到你在说话。'
\zl
...
\gll weil den ganzen Tag gearbeitet wurde\\
	 因为 \textsc{det}.\acc{} 整.\acc{} 天 工作 \textsc{aux}\\
\glt `因为有人整天工作'
}
\ex[*]{
...
\zl
        ...
        \gll Er lässt den lieben Gott `n frommen Mann sein.\\
	     他 让 \textsc{det}.\acc{} 亲爱的.\acc{} 上帝 \textsc{art} 虔诚的.\acc{} 人 \textsc{cop}\\
        \glt `他完全是不走心（漠不关心）啊。'
        }
        \ex[*]{
        \gll Er lässt den lieben Gott `n frommer Mann sein.\\
	     他 让 \textsc{det}.\acc{} 亲爱的.\acc{} 上帝 \textsc{art} 虔诚的.\nom{} 人 \textsc{cop}\\
        }
        \zllast}
...
\gll Sie nannte ihn einen Lügner.\\
	 她 叫 他.\acc{} \textsc{art}.\acc{} 骗子\\
\glt “她把他叫做骗子。”
\ex 
\gll Er wurde ein Lügner genannt.\\
	 他.\nom{} \textsc{aux} \textsc{art}.\nom{} 骗子 叫做\\
\glt “他被人叫做骗子。”
\zl
...
\gll Ten pounds are weighed / ten dollar are cost by this book.\\
      十 磅  \textsc{aux} 重 / 十 美元 \textsc{aux} 花费 \textsc{prep} 这 书\\
}
\zl
...
\gll Das Buch kostete einen Dollar.\\
       \textsc{det} 书 值 \textsc{art}.\acc{} 美元\\
\glt ｀这本书值一美元。‘
\ex 
\gll Das Buch wiegt einen Zentner.\\
     \textsc{det} 书 重 \textsc{art}.\acc{} 公担\\
\glt ｀这本书重五十公斤。’
\zl
...
\gll (Peter hat erzählt,) dass er das Eis gegessen \emph{hat}.\\
     \hspaceThis{(}Peter \textsc{aux} 告诉 \textsc{conj} 他 \textsc{det} 雪糕 吃 \textsc{aux}\\
\glt `Peter说他把雪糕吃完了。'
\ex 
...
\gll egal,      was  noch  passiert, der Norddeutsche Rundfunk             steht  schon   jetzt als Gewinner fest.\footnotemark\\
     无论如何 什么 仍然 发生 \textsc{det} 北德 广播公司 存在 已经 现在 \textsc{prep} 赢家 \particle\\
\footnotetext{
...
\gll Interessant, zu erwähnen, daß ihre Seele völlig    in Ordnung war.\footnotemark\\
	 有趣 INF 提到 \textsc{conj} 她的 灵魂 完整地 \textsc{prep} 顺序 \textsc{cop}\\
\footnotetext{
...
\gll Ein Treppenwitz der    Musikgeschichte, daß die Kollegen   von Rammstein vor    fünf Jahren noch im      Vorprogramm   von Sandow spielten.\footnotemark\\
	 \textsc{art} 讽刺 \textsc{det} 音乐历史 \textsc{conj} \textsc{det} 成员 \textsc{prep} Rammstein \textsc{prep} 五 年 仍然 \textsc{prep}.\textsc{det} 开场 \textsc{prep} Sandow 表演\\
\footnotetext{
...
\gll Interessant ist zu erwähnen, dass ihre Seele völlig in Ordnung war.\\
	 有趣 \textsc{cop} INF 提到 \textsc{conj} 她的 灵魂 完整地 \textsc{prep} 顺序 \textsc{cop}\\
\glt `值得注意的是，她的灵魂完好无损。'
\ex %{\raggedright
\gll Ein Treppenwitz der Musikgeschichte ist, dass die Kollegen von~~~~~~ Rammstein vor fünf Jahren noch im Vorprogramm von Sandow spielten.\hspace{-5pt}\\
	 \textsc{art} 讽刺 \textsc{det} 音乐历史 \textsc{cop} \textsc{conj} \textsc{det} 成员 \textsc{prep} Rammstein \textsc{prep} 五 年 仍然 \textsc{prep}.\textsc{det} 开场 \textsc{prep} Sandow 表演\\
    %\par}     
...
\gll Er hat [der Frau] das Buch gegeben, [die er kennt].\\
     他 \textsc{aux} \spacebr{}\textsc{det} 女人 \textsc{det} 书 给 \spacebr{}\textsc{conj} 他 认识\\
\glt `他把书交给了他认识的那个女人。'
}
\ex[*]{
\gll Er hat [der Frau] das Buch, [die er kennt,] gegeben.\\
     他 \textsc{aux} \spacebr{}\textsc{det} 女人 \textsc{det} 书 \spacebr{}\textsc{conj} 他 认识 给\\
}
\ex[]{
\gll Er hat [der Frau, die er kennt,] das Buch gegeben.\\
     他 \textsc{aux} \spacebr{}\textsc{det} 女人 \textsc{conj} 他 认识 \textsc{det} 书 给\\
}
\zl
...
\gll Er gibt das Buch der Frau, die er kennt.\\
      他 给 \textsc{det} 书 \textsc{det} 女人 \textsc{conj} 他 认识\\
\glt `他把书交给了他认识的那个女人。'
\z
%\addlines
...
\gll Er hat das Buch [der Frau] gegeben, [die er kennt].\\
     他 \textsc{aux} \textsc{det} 书 \spacebr{}\textsc{det} 女人 给 \spacebr{}\textsc{conj} 他 认识\\
\glt `他把书交给了他认识的那个女人。'
\ex 
\gll Er hat das Buch [der Frau, die er kennt,] gegeben.\\
	 他 \textsc{aux} \textsc{det} 书 \spacebr{}\textsc{det} 女人 \textsc{conj} 他 认识 给\\
\zl
...
\gll der Mann,         [mit dem] du gesprochen hast\\
     \textsc{det} 人 \spacebr{}\textsc{prep} 谁 你 说话 \textsc{aux}\\
\glt `你跟他说话的那个人'	 
\ex 
...
\gll Er [kennt und liebt] diese Schallplatte.\\
     他 \spacebr{}知道 和 热爱 \textsc{det} 专辑\\
\glt `他了解并且热爱这张专辑。'
\z
} 
...
\gll Über dieses Thema habe ich ihn gebeten, einen Vortrag zu halten.\\
      关于 \textsc{det} 题目  \textsc{aux} 我   他 请求    \textsc{art}     演讲   INF hold\\
\glt `我请他做个有关这个题目的演讲。'
\ex 
\gll das Thema, über das ich ihn gebeten habe, einen Vortrag zu halten\\
     \textsc{det} 题目  关于  我 他 请求  \textsc{aux} \textsc{art} 演讲 INF 作\\
\glt `这是那个我让他做一个演讲的题目'
\zl
...
\gll Kommt drauf an, mit wem dass sie zu tun haben.\\
     来 \textsc{prep} \partic{} \textsc{prep} 谁 \textsc{conj} 你 INF 做 \textsc{aux}\\
\glt `这要取决于是谁在处理。'
%\ex
\zl
\eal
...
\gll Lotti, die wo eine tolle Sekretärin ist, hat ein paar merkwürdige~~~~~~ Herren empfangen.\\
     Lotti  谁 哪儿 \textsc{art} 伟大 秘书 \textsc{cop} 有 \textsc{art} 些 奇怪 绅士 欢迎\\
\glt `Lotti作为一名伟大的秘书，受到了一些奇怪的绅士的欢迎。'
\ex 
\gll Du bist der beste Sänger, den wo ich kenn.\\
     你 \textsc{cop} \textsc{det} 最棒 歌手   谁 哪儿 我 知道\\
\glt `你是我知道的最棒的歌手。'
\zl
...
\gll Die Möglichkeit, etwas zu verändern, ist damit verschüttet für lange lange Zeit.\\
	 \textsc{det} 机会 东西 INF 变化 \textsc{cop} 在那儿 消失 \textsc{prep} 长 长 时间\\
\glt `变革的机会将要消失很长很长时间了。'	  
\ex 
\gll {}[Verschüttet für lange lange Zeit] ist damit die Möglichkeit,      etwas zu ver"-ändern.\\
      \spacebr{}消失 \textsc{prep} 长 长 时间 \textsc{cop} 在那儿 \textsc{det} 机会  东西 INF 变化\\
\ex 
\gll Wir haben schon seit langem gewußt, daß du kommst.\\
     我们 \textsc{aux} \particle{} \textsc{conj} 长 知道 \textsc{conj} 你 来\\
\glt `我们早就知道你要来了。'
\ex 
\gll {}[Gewußt, daß du kommst,] haben wir schon seit langem.\\
	 \spacebr{}知道 \textsc{conj} 你 来 \textsc{aux} 我们 \particle{} \textsc{prep} 长\\
\zl
...
\gll Der Mann liebt eine Frau, den Peter kennt.\\
     \textsc{det} 男人  爱   \textsc{art} 女人 谁 Peter 认识\\
\glt `Peter认识的那个男人爱着这个女人。'
\ex 
\gll Der Mann liebt eine Frau, die Peter kennt.\\
	 \textsc{det} 男人 爱 \textsc{art} 女人 \textsc{conj} Peter 认识\\
\glt `这个男人爱着那个彼得认识的女人。'
...
\gll Der Mittwoch, der passt mir gut.\\
	 \textsc{det} 星期三 \textsc{conj} 适合 我 好\\
\glt `周三，我有空。'
\z
\eal
\ex 
\gll Aber würde denn jemand den Hund füttern morgen Abend?\\
     但是 \textsc{aux} \particle{} 有人 \textsc{det} 狗 喂 明天 晚上\\
\glt `但是明天晚上会有人喂狗吗？'
\ex 
\gll Denn dass es regnet, damit rechnet keiner.\\
     因为 \textsc{conj} 它 下雨 对此 想到 没有人\\
\glt `因为没人想到会下雨。'
\zl
