...
\gll Ich komme eben        aus der          Stadt, \emph{wo}    ich Zeuge eines Unglücks gewesen bin.\footnotemark\\
     我  来     \particle{} 自  \textsc{det} 城市   \textsc{conj} 我  见证  \textsc{art} 事故 \textsc{cop} \textsc{aux} \\
\footnotetext{
...
\gll Ég vonast til  að verða hjálpað.\\
     我 希望    \textsc{prep} \textsc{comp} \textsc{aux} 帮助\\
\glt `我希望我能得到帮助。'
\ex
\gll Að vera hjálpað í prófinu er óleyfilegt.\\
     \textsc{comp} \textsc{aux} 帮助 \textsc{prep} 考试 \textsc{cop} 不允许\\
\glt `在考试中是不允许被帮助的。'
\zl
