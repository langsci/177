...
所有的语言表达都有意义。据此，我们研究形式与意义的结合体\citep{Saussure16a}\nocite{Saussure16a-Fr}。例如，tree（树）这个词的书写形式与其相应的语音形式被赋予了\relation{tree}的含义。较大的语言单位可以由相对较小的单位构成：词与词可以一起构成词组并且这些词组可以继而构成句子。
...
\gll dass keiner [diese Frau] kennt\\
     \textsc{comp} 没有人 这 女人 认识\\
     \mytrans{没有人认识这个女人}
  }
\ex[]{
\gll dass [diese Frau] keiner kennt\\
	 \textsc{comp} 这 女人 没有人 认识\\
\mytrans{没有人认识这个女人}
  }
\zl
