...
%combination under the phrasal approach. 
    ...
    下面的论述看似可以说明动词与构式可以自由组合：\dotfootnote{这些引文的语境很清楚，动词和论元结构都被当做构式。参见 \citet[\page 21，例（2）]{Goldberg2006a}。} 
...
对于\isce[|(]{提升}{raising} （\mex{1}a）中的句子，Haugereid（个人交流 \, 2007）给出如（\mex{1}b）所示的语义表征：\dotfootnote{%
...
\subsection{连动式}
有些语言\iscesub[|(]{动词}{verb}{连动式}{serial}\ilce[|(]{现代汉语}{Mandarin Chinese}有所谓的连动式。例如，在现代汉语中可以构成只有一个主语和几个动词短语的句子\citep[\S~21]{LT81a}。连动式有多种意义，具体意义是什么取决于VP当中体标记的分布：\dotfootnote{%
