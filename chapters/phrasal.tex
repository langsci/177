...
\gll With nothing left after the soldier's [destruction and looting] of their home, they reboarded their coach and set out for the port of Calais.\\
    \textsc{prep} 没有东西 留下 \textsc{prep} \defart{} 士兵的 \spacebr{}破坏 和 抢劫 \textsc{prep} 他们的 家 他们 重新上 他们的 马车 和 出发 \textsc{adv} \textsc{prep} \defart{} 港口 \textsc{prep} 加来\\
...
这一论述的事实根据是推定的动转名词是否允许施事论元表达：动词，如grow（种植），允许施事论元表达，但是同源名词，如growth（种植），不允许。但是，事实证明，grow/growth同源对是很少见的。大多数动转名词在是否能允许施事论元出现方面与同源动词一样。另外，对于grow/growth这种例外情况，也有很好的解释\citep{Wechsler2008a}。首先考虑一下非--转换只有客体的不及物动词（非受格\isce{动词}{verb}{非受格}{unaccusative}），如（\ref{arrive1}）所示；以及非--转换及物动词，如（\ref{trans}）所示。模式很清晰：如果动词没有施事论元，那么名词也没有：
...
\gll John smashed the ball \emph{out} \emph{of} \emph{the} \emph{room}.\\
     John 猛击 \defart{} 球 \textsc{prep} \textsc{prep} \defart{} 房间\\
\mytrans{John把球扣出了房间。}
...
\gll John dripped himself two drops of water.     \\
     John 滴下 REFL 两 滴 \textsc{prep} 水\\\jambox{（arg123—框架）}
...
\gll John dripped himself two drops of water into~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ his eyes. \\
     John 滴下 REFL 两 滴 \textsc{prep} 水 \textsc{prep} 他的 眼睛\\\jambox{（arg1234—框架）}
...
\gll John dripped himself two drops of water into~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ his eyes with a drop counter. \\
     John 滴下 REFL 两 滴 \textsc{prep} 水 \textsc{prep} 他的 眼睛 \textsc{prep} 一 滴 计数器\\\jambox{（arg12345—框架）}
...
正如我在\ref{sec-passive-bcg}中指出的那样，基于承继的方法不能解释配价的多重改变，例如被动和无人称构式，这种现象可见于立陶宛语\ilce{立陶宛语}{Lithuanian}\citep[第5节]{Timberlake82a}、爱尔兰语\ilce{爱尔兰语}{Irish}\citep{Noonan94a}和\ilce{土耳其语}{Turkish}\citep{Ozkaragoez86a}。Özkaragöz举出的土耳其语的例子重复写在这里，仍保留原有的标注方法，见（\ref{ex-double-passivization-two}）：
...
\gll \emph{Los} damit \emph{geht} es schon am 15. April.\footnotemark\\
      \textsc{part} \textsc{adv} 走 \expl{} 已经 \textsc{prep}.\defart{} 15 4月\\%
\footnotetext{%
...
\gll Der kranke Mann wünschte sich,   [totgeschossen zu werden].\footnotemark\\
     \defart{} 生病的   人  希望   \self{} \spacebr{}死.射击      \textsc{inf} \passive\\
\footnotetext{%
...
\gll {}[\sub{vf} [\sub{vc} Los]        [\sub{nf} damit]]    geht es schon   am 15. April.\footnotemark\\
       {}        {}        \textsc{part}  {}        \textsc{adv} 开始 \expl{} 已经 \textsc{prep}.\defart{} 15 四月\\%
...
\gll Day after day after day went by, but I never found the courage to talk to her.\\
	 天 \textsc{prep} 天 \textsc{prep} 天 走 \textsc{adv} 但是 我 从未 找到 \defart{} 勇气 \textsc{inf} 说话 \textsc{prep} 她\\
