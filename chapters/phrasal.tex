...
\gll After several lorries had run over the body, there was rabbit splattered all over the road.\\
     在之后 几辆 货车 \textsc{aux} 驶过 \textsc{det} 身体 有 \textsc{cop} 兔子 散布 全部 在上 路\\
...
\gll das Leerfischen der Nordsee in fünf Jahren\\
     \textsc{det} 空.钓鱼 \textsc{prep}.\textsc{det} 北海 在 五 年\\
}
\ex[\#]{
...
\begin{quote}
主要观点是如果我们认为构式具有其自身的意义，并且这种意义是独立于出现于构式之中的动词的，那么我们就不需要为我们在日常生活中使用的动词在词库中列举不合理的意义。假设构式具有意义的构式语法因此比词汇规则方法更加简单并且更加合理。\citep[\page 161]{Tomasello2003a}
...
\gll She then offered and made me a wonderful espresso -- nice.\\
     她  然后 提供 并且 做 我 \textsc{art} 极好的 浓咖啡\\
...
\gll ich hab ihr jetzt diese Ladung Muffins mit den Herzchen drauf gebacken und gegeben.\footnotemark\\
     我 \textsc{aux} 她 现在 \textsc{det} 装载 松饼 \textsc{prep} \textsc{det} 小.心 那里.\textsc{prep}~~~~ 烤 并且 给\\
\footnotetext{
...
高尔夫.俱乐部.\textsc{def} 要求 并且 授予-\textsc{pass} 土地.允许 \textsc{prep} 小路.建设.\textsc{def} \textsc{prep} \textsc{art} 整个 部分 谈判 并且 妥协 \textsc{prep} 国家.董事会.\textsc{def} 和 自然.保护.机构.\textsc{def} \\
...
\gll The suspect should be considered [armed and dangerous].\\
    \textsc{det} 嫌疑犯 \textsc{aux} \textsc{cop} 认为 携带武器的 并且 危险的\\
...
\gll With nothing left after the soldier's [destruction and looting] of their home, they reboarded their coach and set out for the port of Calais.\\
    \textsc{prep} 没有东西 留下 \textsc{prep} \textsc{det} 士兵的 破坏 并且 抢劫 \textsc{prep} 他们的 家 他们 回去 马车 设置 \textsc{prep} \textsc{prep} \textsc{det} 港口 \textsc{prep} 加来\\
...
\gll The [cultivation, growing or distribution] of medical marijuana within the County shall at all times occur within a secure, locked, and fully enclosed structure, including a ceiling, roof or top,and shall meet the following requirements.\\
    \textsc{det}  耕作 种植 或者 分发 \textsc{prep} 医用的 大麻 \textsc{prep} \textsc{det} 国家 \textsc{aux} \textsc{prep} 所有的 时间 进行 \textsc{prep} \textsc{art} 安全的 封锁的 并且 全部 封闭的 结构 包括 \textsc{art} 天花板 屋顶 或者 顶部 并且 \textsc{aux} 达到 \textsc{det}下面的 要求\\
...
\gll Realizing the dire results of such a capture and that he was the only one to prevent it, he quickly [saddled and mounted] his trusted horse and with a grim determination began a journey that would become legendary.\\
    实现 \textsc{det} 悲惨的 结果 \textsc{det} 这样 \textsc{art} 捕获 和 那 他 \textsc{cop} \textsc{det} 唯一 一个 \textsc{prep} 阻止 它 他 很快地 装马鞍 并 骑上 他的 值得信任的 马 并且 \textsc{prep} \textsc{art} 残忍的 决定 开始 \textsc{art} 旅程 \textsc{conj} \textsc{aux} 变成 传奇\\
...
\gll {}[dass] jemand die Nordsee leer fischt\\
     {}\spacebr{}REL 某人 \textsc{det} 北.海 空 钓鱼\\
...
\gll wegen      der \emph{Leerfischung}  der    Nordsee\footnotemark\\
     因为 \textsc{prep}.\textsc{det} 空.钓鱼 \textsc{prep}.\textsc{det} 北.海\\
\footnotetext{
...
\gll wegen der Leerfischung der Nordsee durch die Anrainerstaaten\\
     因为 \textsc{prep}.\textsc{det} 空.钓鱼 \textsc{prep}.\textsc{det} 北.海 \textsc{prep} \textsc{det} 邻近的.州\\
...
[NP
	...
	[N$'$
		[N
			[Leerfischung;空.钓鱼]]
		[NP{[\textit{gen}]}
			[der Nordsee;\textsc{prep}.\textsc{det} 北.海, roof]]]]
\end{forest}
%\hfill\mbox{}
...
\gll The performer sang the children a song.\\
     \textsc{det} 歌手 唱歌 \textsc{det} 孩子们 \textsc{det} \textsc{art} 歌曲\\
\glt `这个歌手给孩子们唱了一首歌。'
%The performer sang the children a song.
\ex 
\gll The children were sung a song.\\
     \textsc{det} 孩子们 \textsc{cop} 唱歌 \textsc{art} 歌曲\\
\glt `这些孩子被唱了一首歌。'
...
\gll der seiner Frau einen Kuchen backende Mann\\
     \textsc{det} 他的.\dat{} 妻子 \textsc{art}.\acc{} 蛋糕 烤 人\\
\glt `那个为她烤蛋糕的人'
%\gll der seiner Frau einen Kuchen backende Mann\\
...
\gll der einen Kuchen seiner Frau backende Mann\\
     \textsc{det} \textsc{art}.\acc{} 蛋糕  他的.\dat{} 妻子 烤 人\\
\glt `那个为她烤蛋糕的人'
%\gll der einen Kuchen seiner Frau backende Mann\\
...
\gll The drunk refused to kill NP.\\
     \textsc{det} 喝醉的 拒绝 \textsc{prep} 杀死 NP\\
\glt `这个醉汉拒绝杀死NP。'
...
\gll the tomatoes' growth, the growth of the tomatoes\\
     \textsc{det} 西红柿.GEN 生长 \textsc{det} 生长 GEN \textsc{det} 西红柿\\
\glt `西红柿的种植，西红柿的种植'
...
\gll that the army destroyed the city\\
     REL \textsc{det} 军队 破坏 \textsc{det} 城市\\
\glt `军队破坏这座城市这件事'
...
\gll the army's destruction of the city\\
     \textsc{det} 军队.GEN 破坏 GEN \textsc{det} 城市\\
\glt `军队破坏这座城市'
...
\gll The army is destroying the city.\\
     \textsc{det} 军队 \textsc{cop} 破坏 \textsc{det} 城市\\
\glt `军队正在破坏这座城市'
...
\gll weil (es) mir (vor der Prüfung) graut\\
     因为 \hspaceThis{(}\textsc{expl} 我.\dat{} \hspaceThis{(}在之前 \textsc{det} 考试 恐惧\\\\
\glt `因为我很害怕考试。'
%\gll weil (es) mir (vor der Prüfung) graut\\
...
\gll weil er es bis zum Professor bringt\\
     因为 他 \textsc{expl} 知道 \textsc{prep}.\textsc{det} 教授 带来\\
\glt `因为他赶上了教授。'
%\gll weil er es bis zum Professor bringt\\
...
\gll He painted the car \emph{a} \emph{brilliant} \emph{red}.\\
     他 喷漆 \textsc{det} 车 \textsc{art} 亮 红\\
\glt `他将车子喷成亮红色。'
...
\gll John punctured the balloon \emph{with} \emph{a} \emph{needle}.\\
     他 刺穿 \textsc{det} 气球 \textsc{prep} \textsc{art} 针\\
\glt `他用针将这个气球刺破了。'
...
\gll John dripped himself two drops of water into his eyes with a drop counter. \jambox{(arg12345-frame)}\\
     John 滴下 REFL 两 滴 \textsc{prep} 水 \textsc{prep} 他的 眼睛 \textsc{prep} \textsc{art} 滴 计数器\\
...
\gll The strings [that Pat pulled] got Chris the job.\\
     \textsc{det} 绳子 REL Pat 拉 获得 Chris \textsc{det} 工作\\
...
\gll Der kranke Mann wünschte sich,   [totgeschossen zu werden].\footnotemark\\
     \textsc{det} 生病的   人  希望   \self{} \spacebr{}死.射杀      INF \textsc{cop}\\
\footnotetext{
...
\gll dann scheint uns das Totschießen mindestens ebensoviel Spaß zu machen\footnotemark\\
     那么 \textsc{cop}   我们  \textsc{det} 死-射杀 \textsc{prep}.最少 \textsc{prep}.\textsc{det}    乐趣 INF 制造\\
\footnotetext{
...
\gll give George a book and Martha a record\\
     给 George \textsc{art} 书 和 Martha \textsc{art} 唱片\\
...
\gll He gave George and sent Martha a record.\\
     他 给 George 并且 寄给 Marhta \textsc{art} 唱片\\
...
\gll He loaded hay onto the wagon.\\
     他 装车 干草 \textsc{prep} \textsc{det}P 货车\\
\glt `他往货车中装干草。' 
%He loaded hay onto the wagon.
\ex
\gll He loaded the wagon with hay.\\
     他l 装车 \textsc{det} 卡车 \textsc{prep} 干草\\
\glt `他将卡车装满了 
...
\gll take a walk to the park\\
     带走 \textsc{art} 散步 \textsc{prep} \textsc{det} 公园\\
\glt `散步到公园'
...
\gll take a frisbee to the park\\
     带走 \textsc{art} 飞盘 \textsc{prep} \textsc{det} 公园\\
\glt `带个飞盘去公园'
...
\begin{quote}
除了将范畴连接起来，典型的DCNA还建立了范畴成分之间的时间顺序。不对时间顺序提出要求的DCNA（所以，原则上，相当于两个成分的AND单位）会组合顺序自由或允许置换的成分。\citep*[\page 404]{PCShandbookCxG}
...
\gll {}[\sub{vf} [\sub{mf} Wieder] [\sub{vc} an]] treten auch die beiden Sozialdemokraten.\footnotemark\\
      {}         {}        再   {}        \partic{} 踢 也 \textsc{det} 二 社会.民主党\\
...
\footnotemark\\
    \spacebr{}Heath Ledger \textsc{aux} 我 NEG 甚至 写 \textsc{prep} 那个 我 他的 \textsc{prep}.\textsc{det} 草地.一点 再次 这样
    疯狂 悲伤 \textsc{aux}\\
\footnotetext{
...
\begin{quote}
这些结构对于搭配词位分析很典型，因为它们说明了两件事。首先，实际上词项和语法结构之间具有重要的联系。第二，这些联系为语义一致提供了清晰的证据：被强吸引的组合词位都涉及“转移”概念，或者是字面上的或者是隐喻的，对于双及物结构来说这都很典型。这种结果足够典型来支持一个概括观点，搭配构式分析实际上可以用于首先识别语法构式的意义。\citep[\page 943]{SG2009a}
...
\gll Wozu braucht man Konstruktionen? / Wozu sollte man Konstruktionen annehmen?\\
     \textsc{prep}.什么 需要 一个 构式 {} \textsc{prep}.什么 应该 一个 构式 假设\\
...
\gll Warum soll ich das machen? / Warum wurde ich ausgewählt? / Warum passiert mir sowas?\\
	 为什么 应该 我 那个 \textsc{aux} {} 为什么 \textsc{cop} 我 选择 {} 为什么 发生 我 一些事情.像.那\\
...
\gll Den Hut in der Hand haltend kam er ins Zimmer.\\
	 \textsc{det} 帽子.\acc{} \textsc{prep} \textsc{det} 手 抓着 来 \textsc{det} \textsc{prep}.\textsc{det} 房间\\
\glt `他拿着一顶帽子进入房间。'
%\gll Den Hut in der Hand haltend kam er ins Zimmer.\\
...
\gll Her  mit  dem Geld   / dem gestohlenen Geld!\\
     这里 \textsc{prep} \textsc{det} 钱 {} \textsc{det} 被偷的 钱\\
\glt `将偷的钱拿过来！'
%\gll Her  mit  dem Geld   / dem gestohlenen Geld!\\
...
\gll Weg  mit  dem Krempel / dem alten Krempel!\\
     \textsc{prep} \textsc{prep} \textsc{det} 废品   {} \textsc{det} 旧 废品\\
\glt `丢掉这件（旧）废品！'
%\gll Weg  mit  dem Krempel / dem alten Krempel!\\
...
\gll Nieder mit den Studiengebühren / den sozialfeindlichen Studiengebühren!\\
     \textsc{prep} \textsc{prep} \textsc{det} 学费.费用  {} \textsc{det} 反社会的 学费.费用\\
\glt `降低（反社会）学费！'
%\gll Nieder mit den Studiengebühren / den sozialfeindlichen Studiengebühren!\\
...
\gll In den Müll mit diesen Klamotten!\\
     \textsc{prep} \textsc{det} 垃圾 \textsc{prep} \textsc{det} 衣服\\
\glt `将这些衣服扔到垃圾里！'
%\gll In den Müll mit diesen Klamotten!\\
...
\gll Zur Hölle mit dieser Regierung!\\
	 \textsc{prep}.\textsc{det} 地狱 \textsc{prep} \textsc{det} 政府\\
\glt `这个政府见鬼去吧！'
%\gll Zur Hölle mit dieser Regierung!\\
...
\gll {}[dass] jemand diese Klamotten in den Müll schmeißt\\
     {}\spacebr{}REL 某人 \textsc{det} 衣服 \textsc{prep} \textsc{det} 垃圾 扔\\
\glt `某人将这些衣服扔到垃圾里这件事'     
%\gll {}[dass] jemand diese Klamotten in den Müll schmeißt\\
...
\gll Wohin mit den Klamotten?\\
	 哪里.\textsc{prep} \textsc{prep} \textsc{det} 衣服\\
\glt `这些衣服应该去哪里？'
%\gll Wohin mit den Klamotten?\\
...
\gll Wohin mit dem ganzen Geld?\\
	 哪里.\textsc{prep} \textsc{prep} \textsc{det} 整个 钱\\
\glt `所有这些钱应该去哪里？'
%\gll Wohin mit dem ganzen Geld?\\
...
\gll Weg mit dem Krempel!\\
	 \textsc{prep} \textsc{det} 垃圾\\
%\gll Weg mit dem Krempel!\\
%	 away with the junk\\
}
\ex[]{
\gll Schnell weg mit dem Krempel!\\
	 快 \textsc{prep} \textsc{prep} \textsc{det} 垃圾\\
%\gll Schnell weg mit dem Krempel!\\
%	 quickly away with the junk\\
}
\ex[?*]{
\gll Sorgfältig weg mit dem Krempel!\\
	 仔细地 \textsc{prep} \textsc{prep} \textsc{det} 垃圾\\
%\gll Sorgfältig weg mit dem Krempel!\\
...
\gll Und mit dem Klavier ganz langsam durch die Tür!\\
	 并且 \textsc{prep} \textsc{det} 钢琴 ADV ADV \textsc{prep} \textsc{det} 门\\
\glt `很慢地搬着钢琴通过门！'
%\gll Und mit dem Klavier ganz langsam durch die Tür!\\
...
\gll What a fool he is!\\
     Q \textsc{art} 傻 他 \textsc{cop}\\
\glt `他这个傻瓜！'
%What a fool he is!
\ex
\gll It's amazing \emph{how odd it is}.\\
     它 奇怪 Q 奇怪 它 \textsc{cop}\\
\glt `他那么奇怪真是令人吃惊！' 
...
\gll Er hat dieses Buch um jenes Buch verschlungen.\\
	 他 \textsc{aux} \textsc{det} 书 \textsc{prep} \textsc{det} 书 吞咽\\
%\gll Er hat dieses Buch um jenes Buch verschlungen.\\
%	 he has this book around this book swallowed\\
} 
\ex[*]{
\gll Er hat ein Buch um ein Buch verschlungen.\\
	 他 \textsc{aux} \textsc{art} 书 \textsc{prep} \textsc{det} 书 吞咽\\
%\gll Er hat ein Buch um ein Buch verschlungen.\\
...
\gll Day after day after day went by, but I never found the courage to talk to her.\\
	 天 \textsc{prep} 天 \textsc{prep} 天 走 \textsc{prep} 但是 我 NEG 找到 \textsc{det} 勇气 \textsc{prep} 说话 \textsc{prep} 她\\
