...
\gll The         suspect should     be           considered [armed and dangerous].\\
    \textsc{det} 嫌疑犯 \textsc{aux} \textsc{aux} 认为        \spacebr{}携带武器的 并且 危险的\\
...
\gll With         nothing left after        the          soldier's [destruction and looting] of their home, they reboarded their coach and set out for the port of Calais.\\
    \textsc{prep} 没有东西 留下 \textsc{prep} \textsc{det} 士兵的     \spacebr{}破坏 并且 抢劫 \textsc{prep} 他们的 家 他们 回去 马车 设置 \textsc{prep} \textsc{prep} \textsc{det} 港口 \textsc{prep} 加来\\
...
\gll Realizing the dire results of such a capture and that he was the only one to prevent it, he quickly [saddled and mounted] his trusted horse and with a grim determination began a journey that would become legendary.\\
    实现 \textsc{det} 悲惨的 结果 \textsc{det} 这样 一 捕获 和 那 他 \textsc{cop} \textsc{det} 唯一 一个 \textsc{prep} 阻止 它 他 很快地 \spacebr{}装马鞍 并 骑上 他的 值得信任的 马 并且 \textsc{prep} 一 残忍的 决定 开始 一 旅程 \textsc{conj} \textsc{aux} 变成 传奇\\
...
\gll that the army destroyed the city\\
     \textsc{conj} \textsc{det} 军队 破坏 \textsc{det} 城市\\
\glt `军队破坏这座城市这件事'
...
\gll John dripped himself two drops of water.     \jambox{(arg123-frame)}\\
     John 滴下 \textsc{refl} 两 滴 \textsc{prep} 水\\
\glt `John给自己滴了两滴水。' 
...
\gll John dripped himself two drops of water into his eyes. \jambox{(arg1234-frame)}\\
     John 滴下 \textsc{refl} 两 滴 \textsc{prep} 水 \textsc{prep} 他的 眼睛\\
...
\gll John dripped himself two drops of water into his eyes with a drop counter. \jambox{(arg12345-frame)}\\
     John 滴下 \textsc{refl} 两 滴 \textsc{prep} 水 \textsc{prep} 他的 眼睛 \textsc{prep} 一 滴 计数器\\
...
\gll Und wer einen Tag sich ausruht,\\
     并且 \textsc{rel} 一 日子 \textsc{self} 休息\\
%\gll Und wer einen Tag sich ausruht,\\
...
\gll {}[dass] jemand diese Klamotten in den Müll schmeißt\\
     {}\spacebr{}\textsc{conj} 某人 \textsc{det} 衣服 \textsc{prep} \textsc{det} 垃圾 扔\\
\glt `某人将这些衣服扔到垃圾里这件事'     
%\gll {}[dass] jemand diese Klamotten in den Müll schmeißt\\
...
\gll  I want to know [why] you did this.\\
     我 想 \textsc{prep} 知道 \textsc{que} 你 做 这\\
\glt `我想知道你为什么做这件事。' 
...
\gll I'm looking for a bank \emph{in which to place my trust}.\\
     我 见 \textsc{prep} 一 银行 \textsc{prep} \textsc{rel} \textsc{prep} 放置 我的 基金\\
