...
\gll \emph{Los} damit \emph{geht} es schon am 15. April.\footnotemark\\
      \textsc{part} \textsc{adv} 走 它 已经 \textsc{prep}.\textsc{det} 15 4月\\%
\footnotetext{%
...
\gll {}[\sub{vf} [\sub{vc} Los]        [\sub{nf} damit]]    geht es schon   am 15. April.\footnotemark\\
       {}        {}        \textsc{part}  {}        \textsc{adv} 开始 它 已经 \textsc{prep}.\textsc{det} 15 四月\\%
...
\footnotemark\\
    \spacebr{}Heath Ledger \textsc{aux} 我 \textsc{neg} 甚至 写 \textsc{prep} \textsc{conj} 我 他的 \textsc{prep}.\textsc{det} 草地.一点 再次 这样
    疯狂 悲伤 做\\
\footnotetext{%
