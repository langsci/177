...
\newcommand{\isce}[3][]{%
  ...
  \fi%
  \if@noftnote
    \index[sbc]{#3\hspace{1em}#2#1}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbc\expandafter{\tempnumber}{#3\hspace{1em}#2#1}%
  \fi%
  }
}
\newcommand{\iscesub}[5][]{%
  ...
  \fi%
  \if@noftnote
    \index[sbc]{#3\hspace{1em}#2!#5\hspace{1em}#4#1}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbc\expandafter{\tempnumber}{#3\hspace{1em}#2!#5\hspace{1em}#4#1}%
  \fi%
}
...
\newcommand{\iscesubsub}[7][]{%
  ...
  \fi%
  \if@noftnote
    \index[sbc]{#3\hspace{1em}#2!#5\hspace{1em}#4!#7\hspace{1em}#6#1}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbc\expandafter{\tempnumber}{#3\hspace{1em}#2!#5\hspace{1em}#4!#7\hspace{1em}#6#1}%
  \fi%
}
...
\setCJKmainfont[Scale=MatchUppercase,
                SmallCapsFont={SourceHanSerifSC-Light},
%               SmallCapsFont={SourceHanSerifSC-Heavy},
