...
\newcommand{\iscesub}[4]{%
  \if@noftnote
    \index[sbj]{#1\hspace{1em}#2!#3\hspace{1em}#4}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbj\expandafter{\tempnumber}{#1\hspace{1em}#2!#3\hspace{1em}#4}%
  \fi%
  \if@noftnote
    \index[sbc]{#2\hspace{1em}#1!#4\hspace{1em}#3}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbc\expandafter{\tempnumber}{#2\hspace{1em}#1!#4\hspace{1em}#3}%
  \fi%
}
\newcommand{\iscesee}[4]{%
