...
\newcommand{\isce}[2]{%
  \if@noftnote%
    \index[sbj]{#1\hspace{2em}#2}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@sbj\expandafter{\tempnumber}{#1\hspace{2em}#2}%
    %\indexftn{#1}{\value{footnotemark}}%
  \fi%
}
...
\newcommand{\ilce}[2]{%
  \if@noftnote
    \index[lan]{#1\hspace{2em}#2}%
    \else%
    \edef\tempnumber{\thefootnote}%
    \expandafter\footnoteindex@lan\expandafter{\tempnumber}{#1\hspace{2em}#2}%
  \fi%
}
\makeatother
